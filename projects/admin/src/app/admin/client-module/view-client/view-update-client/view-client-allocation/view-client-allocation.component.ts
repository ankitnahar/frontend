...
@Component({
  ...
  templateUrl: './view-client-allocation.component.html',
  styleUrls: ['./view-client-allocation.component.scss'],
})
export class ViewClientAllocationComponent extends BaseComponent implements OnInit {
