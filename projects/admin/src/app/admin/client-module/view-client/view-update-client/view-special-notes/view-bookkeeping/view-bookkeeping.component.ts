...
@Component({
  ...
  templateUrl: './view-bookkeeping.component.html',
  styleUrls: ['./view-bookkeeping.component.scss'],
})
export class ViewBookkeepingComponent extends BaseComponent implements OnInit {
  // Angular variables
  ...
  /*  openDialog(note?: SpecialNotesData) {
      ...
      const dialogRef = this.dialog.open(AddBookkeepingDialog, dialogConfigData);
