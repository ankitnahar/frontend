...
export class SpecialNotesData {
  ...
  private _archive_by: ArchivedBy;

  get archive_by(): ArchivedBy {
    return this._archive_by;
  }

  set archive_by(value: ArchivedBy) {
...
export class ArchivedBy {
  private _id: number;
  private _archive_on: string;
  private _entity_specialnotes_id: number;
  private _archive_by: AdminUser;
  ...
  get archive_by(): AdminUser {
    return this._archive_by;
  }

  set archive_by(value: AdminUser) {
    this._archive_by = value;
  }
}
