...
import {BUTTONPRIVILEGES} from '../../../manage-users/update-user/privileges/privileges.model';
...
@Component({
  ...
  templateUrl: './edit-other-rights.component.html'
})
export class EditOtherRightsComponent implements OnInit {
