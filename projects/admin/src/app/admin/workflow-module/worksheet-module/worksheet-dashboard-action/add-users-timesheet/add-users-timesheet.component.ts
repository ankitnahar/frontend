...
@Component({
  ...
  templateUrl: './add-users-timesheet.component.html',
  styleUrls: ['./add-users-timesheet.component.scss']
})
export class AddUsersTimesheetComponent extends BaseComponent implements OnInit {
  ...
  createTimesheetForm() {
    this.addTimesheetForm = this._fb.group({
      ...
      user_id: new FormControl(null, <any>Validators.required),
      date: new FormControl(null, <any>Validators.required),
      worksheet_frequency_id: new FormControl((this.worksheetData) ? this.worksheetData.frequency_id : 0),
