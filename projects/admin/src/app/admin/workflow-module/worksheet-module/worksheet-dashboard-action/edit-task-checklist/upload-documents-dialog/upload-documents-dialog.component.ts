...
import {GoogleDriveFile, GoogleDriveFolder, GoogleDriveMetaDataList} from "../../../../../client-module/client-documents/google-drive.model";
...
export class UploadDocumentsDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<UploadDocumentsDialogComponent>,
  ...
  createFolderListForMoveFile() {
    const params = {'entity_id': this.clientData.entity_id};
    // console.log(1);
  ...
  googleDriveList(entity_id: number, parent_id: number, subclient_id: number) {
    ...
    this._commonCrudService.listData(AdminAPI.GOOGLE_DRIVE_LIST, params).subscribe((response) => {
      ...
      if (parent_id === 0 && subclient_id === 0) {
        ...
        this.googleDriveAllFileFolder.entity_id = this.clientData.entity_id;
  ...
  createAdvanceFilterForm() {
    this.filterForm = this._fb.group({
      entity_id: new FormControl(this.clientData.entity_id, Validators.required),
