...
@Component({
  selector: 'app-add-timesheet-dialog-peer-review',
  templateUrl: './add-timesheet-dialog-peer-review.component.html'
})
export class AddTimesheetDialogPeerReviewComponent extends BaseComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AddTimesheetDialogPeerReviewComponent>,
