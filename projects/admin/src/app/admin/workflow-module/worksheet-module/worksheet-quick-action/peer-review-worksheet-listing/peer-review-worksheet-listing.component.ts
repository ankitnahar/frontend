...
@Component({
  ...
  templateUrl: './peer-review-worksheet-listing.component.html',
  styleUrls: ['./peer-review-worksheet-listing.component.scss']
})
export class PeerReviewWorksheetListingComponent extends BaseComponent implements OnInit {
  ...
  downloadExcel() {
    ...
    this._commonCrudService.downloadExcelData(AdminAPI.PEER_REVIEW_WORKSHEET_LISTING, params, this.getSearchParam(), 'Peer Review Worksheet ', 0).subscribe(response => {
    });
  }
   ...
   */
  onCompletedPeerReviewWorksheet() {
    this._router.navigate(['/' + AdminRoutes.WORKSHEET_COMPLETED_PEER_REVIEW_WORKSHEET_LISTING]);
  }
