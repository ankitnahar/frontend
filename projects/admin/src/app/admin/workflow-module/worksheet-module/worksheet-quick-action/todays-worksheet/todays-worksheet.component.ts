...
@Component({
  ...
  templateUrl: './todays-worksheet.component.html',
  styleUrls: ['./todays-worksheet.component.scss']
})
export class TodaysWorksheetComponent extends BaseComponent implements OnInit {
  ...
  createAdvanceFilterForm() {
    this.filterForm = this._fb.group({
      ...
      due_date_from: new FormControl(new Date()),
