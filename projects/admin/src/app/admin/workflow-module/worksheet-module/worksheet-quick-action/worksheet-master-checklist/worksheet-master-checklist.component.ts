...
@Component({
  ...
  templateUrl: './worksheet-master-checklist.component.html',
  styleUrls: ['./worksheet-master-checklist.component.scss']
})
export class WorksheetMasterChecklistComponent implements OnInit {
