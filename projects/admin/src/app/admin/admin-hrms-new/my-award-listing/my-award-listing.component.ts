...
@Component({
  ...
  templateUrl: './my-award-listing.component.html',
  styleUrls: ['./my-award-listing.component.scss']
})
export class MyAwardListingComponent implements OnInit {
   ...
   * @param val
   */
  getMyAwardList(pageNumber: number, key?: string, val?: string) {
    this._commonCrudService.listData(AdminAPI.AWARD_NOMINEE_LIST + '/' + 2, this.getQueryParams(pageNumber, key, val), this.getSearchParam()).subscribe((response) => {
