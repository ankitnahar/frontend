(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["debtors-management-debtors-management-module"],{

/***/ "../../node_modules/@kolkov/angular-editor/fesm5/kolkov-angular-editor.js":
/*!****************************************************************************************************!*\
  !*** C:/wamp64/www/hk_frontend/node_modules/@kolkov/angular-editor/fesm5/kolkov-angular-editor.js ***!
  \****************************************************************************************************/
...
module.exports = "<!--  Start Sub Client List dialog  -->\r\n<div class=\"modal large-modal history-modal debtors-management-comments\">\r\n  <div class=\"modal__header\">\r\n    <div class=\"modal__header__logo\">ADD COMMENTS : {{entityName}}</div>\r\n  </div>\r\n\r\n  <div class=\"modal__close\">\r\n    <a>\r\n      <mat-icon class=\"material-icons\" (click)=\"onClose()\">close</mat-icon>\r\n    </a>\r\n  </div>\r\n  <div class=\"modal__body\">\r\n    <div class=\"view-history-container\">\r\n      <div class=\"MB-10\">\r\n        <form [formGroup]=\"commentForm\" #addEditCommentForm=\"ngForm\" (submit)=\"onSubmitComment(commentForm)\">\r\n          <div class=\"row\">\r\n            <div class=\"col-md-9\">\r\n              <mat-form-field floatLabel=\"never\">\r\n                <textarea formControlName=\"comment\" matInput placeholder=\"Enter Comments\" rows=\"3\"></textarea>\r\n              </mat-form-field>\r\n              <div class=\"validation-msg\">\r\n                <app-validation *ngIf=\"isRequiredField(commentForm.get('comment'))\"\r\n                                [errMsg]=\"validationMsg.COMMENTS\"></app-validation>\r\n              </div>\r\n            </div>\r\n            <div class=\"col-md-3 MT-10 text-left\">\r\n              <mat-checkbox [checked]=\"isSendEmailNotification\" (change)=\"onSelectItem($event.checked)\">Send Email\r\n                Notification\r\n              </mat-checkbox>\r\n              <button type=\"button\" class=\"btn-default MR-5\" (click)=\"resetForm()\">Clear</button>\r\n              <button type=\"submit\" class=\"btn-primary\" [disabled]=\"commentForm.invalid\">Submit</button>\r\n            </div>\r\n            <div class=\"col-md-4 MT-10\" *ngIf=\"isSendEmailNotification\">\r\n              <ng-select class=\"custom\" [items]=\"userList\" [multiple]=\"true\"\r\n                         [closeOnSelect]=\"true\"\r\n                         bindLabel=\"userfullname\"\r\n                         placeholder=\"To\"\r\n                         bindValue=\"email\"\r\n                         [virtualScroll]=\"true\"\r\n                         [searchable]=\"true\"\r\n                         [hideSelected]=\"true\"\r\n                         [(ngModel)]=\"selectedToEmail\"\r\n                         formControlName=\"to_mail\">\r\n              </ng-select>\r\n              <div class=\"validation-msg\">\r\n                <app-validation *ngIf=\"isRequiredField(commentForm.get('to_mail'))\"\r\n                                [errMsg]=\"validationMsg.TO_REQUIRED\"></app-validation>\r\n              </div>\r\n            </div>\r\n            <div class=\"col-md-8 MT-10\" *ngIf=\"isSendEmailNotification\">\r\n              <ng-select class=\"custom\" [items]=\"userList\" [multiple]=\"true\"\r\n                         [closeOnSelect]=\"true\"\r\n                         bindLabel=\"userfullname\"\r\n                         placeholder=\"CC\"\r\n                         bindValue=\"email\"\r\n                         [virtualScroll]=\"true\"\r\n                         [searchable]=\"true\"\r\n                         [hideSelected]=\"true\"\r\n                         [(ngModel)]=\"selectedCCEmail\"\r\n                         formControlName=\"cc_mail\">\r\n              </ng-select>\r\n            </div>\r\n          </div>\r\n        </form>\r\n      </div>\r\n      <ul>\r\n        <div *ngFor=\"let debtorsComment of debtorsManagementComment; let i = index\">\r\n          <li>\r\n            <a>\r\n              <div class=\"profile-icon\">\r\n                <img src=\"assets/images/profile_placeholder.png\" width=\"28\" height=\"28\" alt=\"\"/>\r\n              </div>\r\n              <div class=\"history-details\">\r\n                <div>\r\n                  <h3>Updated By <span>{{debtorsComment?.created_by?.userfullname}}</span></h3>\r\n                  <div class=\"history-time\">\r\n                    <i class=\"material-icons\">query_builder</i>\r\n                    <span>{{debtorsComment?.created_on | date : 'dd-MM-yyy HH:mm:ss'}}</span>\r\n                  </div>\r\n                </div>\r\n                <div>\r\n                  <h5><span *ngIf=\"debtorsComment?.to_mail\"><strong>TO:</strong>{{debtorsComment?.to_mail}}</span><span\r\n                    *ngIf=\"debtorsComment?.cc_mail\"> | <strong>CC:</strong>{{debtorsComment?.cc_mail}}</span></h5>\r\n                </div>\r\n                <div class=\"clearfix\"></div>\r\n                <ul class=\"history-content\">\r\n                  <li>\r\n                    <div><i class=\"material-icons\">done_all</i>\r\n                      <span class=\"fw-500\">{{debtorsComment?.comment}}</span>\r\n                    </div>\r\n                  </li>\r\n                </ul>\r\n              </div>\r\n            </a>\r\n          </li>\r\n        </div>\r\n      </ul>\r\n    </div>\r\n  </div>\r\n\r\n  <mat-paginator [length]=\"totalRecords\"\r\n                 [pageSize]=\"pageSize\"\r\n                 [pageIndex]=\"pageIndex\"\r\n                 [pageSizeOptions]=\"pageArray\"\r\n                 (page)=\"onPageChange($event)\">\r\n  </mat-paginator>\r\n\r\n</div>\r\n<!--  End Change Sub client list dialog  -->\r\n"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.scss":
/*!****************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.scss ***!
  \****************************************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJwcm9qZWN0cy9hZG1pbi9zcmMvYXBwL2FkbWluL2JpbGxpbmctbW9kdWxlL2RlYnRvcnMtbWFuYWdlbWVudC9hZGQtY29tbWVudHMtZGlhbG9nL2FkZC1jb21tZW50cy1kaWFsb2cuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.ts":
/*!**************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.ts ***!
  \**************************************************************************************************************/
/*! exports provided: AddCommentsDialogComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddCommentsDialogComponent", function() { return AddCommentsDialogComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm5/core.js");
...
var AddCommentsDialogComponent = /** @class */ (function (_super) {
    __extends(AddCommentsDialogComponent, _super);
    function AddCommentsDialogComponent(dialogRef, data, _fb, _commonCrudService, _sharedService, _sharedObjService) {
        ...
        _this.debtorsManagementComment = [];
        _this.debtorsEntityID = 0;
        _this.entityName = null;
        _this.selectedToEmail = [];
        _this.selectedCCEmail = [];
        _this.userList = [];
    ...
    AddCommentsDialogComponent.prototype.ngOnInit = function () {
     ...
     * @param event
     */
    AddCommentsDialogComponent.prototype.onSelectItem = function (event) {
        if (event) {
            this.isSendEmailNotification = true;
            this.commentForm.get('to_mail').setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required);
     ...
     * @param form
     */
    AddCommentsDialogComponent.prototype.onSubmitComment = function (form) {
        var _this = this;
        if (form.valid) {
            var formValue = {};
            var toEmail = '';
            ...
            this._commonCrudService.addData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_5__["AdminAPI"].DEBTORS_MANAGEMENT_COMMENT_LIST + '/' + this.debtorsEntityID, formValue).subscribe(function (response) {
                _this.resetForm();
                _this.isSendEmailNotification = false;
                _this.getDebtorsManagementCommentList(1, 'id', 'desc');
            });
        }
    };
    /**
     * Get User List
     */
    AddCommentsDialogComponent.prototype.getUserList = function () {
        var _this = this;
     ...
     * Create Comment Form
     */
    AddCommentsDialogComponent.prototype.createCommentForm = function () {
        this.commentForm = this._fb.group({
            ...
            sent_notification: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null),
            to_mail: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null),
            cc_mail: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null),
        });
    };
    /**
     * Reset Form
     */
    AddCommentsDialogComponent.prototype.resetForm = function () {
        this.createCommentForm();
     ...
     * @param {string} val
     */
    AddCommentsDialogComponent.prototype.getDebtorsManagementCommentList = function (pageNumber, key, val) {
        var _this = this;
        this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_5__["AdminAPI"].DEBTORS_MANAGEMENT_COMMENT_LIST + '/' + this.debtorsEntityID, this.getQueryParams(pageNumber, key, val), {}).subscribe(function (response) {
            _this.debtorsManagementComment = response.payload.data;
     ...
     * @param event
     */
    AddCommentsDialogComponent.prototype.onPageChange = function (event) {
     ...
     * @returns {{}}
     */
    AddCommentsDialogComponent.prototype.getQueryParams = function (page, sortKey, sortOrder) {
        var params = {
            pageNumber: page,
    ...
    AddCommentsDialogComponent.prototype.onClose = function () {
        this.dialogRef.close();
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('addEditCommentForm'),
        __metadata("design:type", Object)
    ], AddCommentsDialogComponent.prototype, "addEditCommentForm", void 0);
    AddCommentsDialogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-add-comments-dialog',
            template: __webpack_require__(/*! ./add-comments-dialog.component.html */ "./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.html"),
            styles: [__webpack_require__(/*! ./add-comments-dialog.component.scss */ "./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.scss")]
        }),
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"], Object, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _utility_shared_service_common_crud_service__WEBPACK_IMPORTED_MODULE_3__["CommonCrudService"], _utility_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"], _utility_shared_service_shared_object_service__WEBPACK_IMPORTED_MODULE_9__["SharedObjService"]])
    ], AddCommentsDialogComponent);
    return AddCommentsDialogComponent;
...
/***/ "./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.html":
/*!********************************************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.html ***!
  \********************************************************************************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"admin-debtors-management-template-edit-container\">\r\n  <!-- Start BreadCrumb Top Header -->\r\n  <div class=\"breadcrumb-top-header\">\r\n    <div class=\"row\">\r\n      <div class=\"col-md-12 PL-0\">\r\n        <div class=\"breadcrumb-top-header__breadcrumbs\">\r\n          <mat-icon class=\"material-icons cursor-pointer\"><a (click)=\"onGoDashboard()\">home</a></mat-icon>\r\n\r\n          <mat-icon class=\"material-icons\">keyboard_arrow_right</mat-icon>\r\n          <span>BILLING</span>\r\n\r\n          <mat-icon class=\"material-icons\">keyboard_arrow_right</mat-icon>\r\n          <span class=\"active\"><a (click)=\"onDebtorsManagement()\">DEBTORS MANAGEMENT</a></span>\r\n\r\n          <mat-icon class=\"material-icons\">keyboard_arrow_right</mat-icon>\r\n          <span class=\"active\">DEBTORS MANAGEMENT EMAIL TEMPLATE</span>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <!-- Over BreadCrumb Top Header -->\r\n  <div class=\"dm-template-edit-container\">\r\n    <h2 class=\"orange-color\">REMINDER EMAIL</h2>\r\n    <div>\r\n      <form [formGroup]=\"emailParametersForm\" (submit)=\"submitDebtorsForm(emailParametersForm)\"\r\n            class=\"row col-md-12 PLR-0\">\r\n        <div class=\"col-md-6\">\r\n          <div class=\"email-parameters__block\">\r\n            <div class=\"row\">\r\n              <div class=\"col-md-12 MB-10 PL-0\">\r\n                <span class=\"primary-color fw-500\">Email Parameters</span>\r\n                <div class=\"row MT-20\">\r\n                  <div class=\"col-md-2\">\r\n                    <label>Client</label>\r\n                  </div>\r\n                  <div class=\"col-md-10\">\r\n                    <span><mat-label>{{debtorsManagement?.billing_name}}</mat-label></span>\r\n                  </div>\r\n                </div>\r\n                <div class=\"row MT-20\">\r\n                  <div class=\"col-md-2\">\r\n                    <label>From</label>\r\n                  </div>\r\n                  <div class=\"col-md-10\">\r\n                    <span>{{billingID}}</span>\r\n                  </div>\r\n                </div>\r\n\r\n                <div class=\"row MT-20\">\r\n                  <div class=\"col-md-2\">\r\n                    <label>To</label>\r\n                  </div>\r\n                  <div class=\"col-md-10\">\r\n                    <mat-form-field [floatLabel]=\"'never'\">\r\n                      <input matInput placeholder=\"To\" readonly formControlName=\"to\"\r\n                             value=\"{{debtorsManagement?.to_email}}\">\r\n                    </mat-form-field>\r\n                  </div>\r\n                </div>\r\n\r\n                <div class=\"row MT-20\">\r\n                  <div class=\"col-md-2\">\r\n                    <label>CC</label>\r\n                  </div>\r\n                  <div class=\"col-md-10\">\r\n                    <mat-form-field [floatLabel]=\"'never'\">\r\n                      <input matInput placeholder=\"CC\" readonly formControlName=\"cc\"\r\n                             value=\"{{debtorsManagement?.cc_email}}\">\r\n                    </mat-form-field>\r\n                  </div>\r\n                </div>\r\n\r\n                <div class=\"row MT-20\">\r\n                  <div class=\"col-md-2\">\r\n                    <label>BCC</label>\r\n                  </div>\r\n                  <div class=\"col-md-10\">\r\n                    <span>{{billingID}}</span>\r\n                    <ng-select [multiple]=\"true\" [items]=\"userList\" [virtualScroll]=\"true\"\r\n                               bindLabel=\"userfullname\"\r\n                               bindValue=\"email\"\r\n                               placeholder=\"Please Select User\"\r\n                               [searchable]=\"true\"\r\n                               class=\"MT-10\"\r\n                               [(ngModel)]=\"selectedUser\" [ngModelOptions]=\"{standalone: true}\"\r\n                               [hideSelected]=\"true\">\r\n                    </ng-select>\r\n                  </div>\r\n                </div>\r\n\r\n                <div class=\"row MT-20\">\r\n                  <div class=\"col-md-2\">\r\n                    <label>Template</label>\r\n                  </div>\r\n                  <div class=\"col-md-10\">\r\n                    <mat-form-field>\r\n                      <mat-select placeholder=\"Template\" formControlName=\"template_type\"\r\n                                  (selectionChange)=\"OnChangeGetDebtorsTemplateData($event.value)\" required>\r\n                        <mat-option *ngFor=\"let debtorsEmail of debtorsTemplate\" [value]=\"debtorsEmail?.id\">\r\n                          {{ debtorsEmail?.template_name}}\r\n                        </mat-option>\r\n                      </mat-select>\r\n                    </mat-form-field>\r\n                    <div class=\"validation-msg\">\r\n                      <app-validation *ngIf=\"isRequiredField(emailParametersForm.get('template_type'))\"\r\n                                      [errMsg]=\"validationMsg.TEMPLATE_DB_REQUIRED\"></app-validation>\r\n                    </div>\r\n                  </div>\r\n                </div>\r\n\r\n\r\n                <div class=\"row MT-20\">\r\n                  <div class=\"col-md-2\">\r\n                    <label>Subject</label>\r\n                  </div>\r\n                  <div class=\"col-md-10\">\r\n                    <mat-form-field [floatLabel]=\"'never'\">\r\n                      <textarea matInput formControlName=\"subject\" [matTextareaAutosize]\r\n                                matAutosizeMinRows=\"3\"></textarea>\r\n                    </mat-form-field>\r\n                    <div class=\"validation-msg\">\r\n                      <app-validation *ngIf=\"isRequiredField(emailParametersForm.get('subject'))\"\r\n                                      [errMsg]=\"validationMsg.SUBJECT_REQUIRED\"></app-validation>\r\n                    </div>\r\n                  </div>\r\n                </div>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n        <div class=\"col-md-6 PL-0\">\r\n          <div class=\"email-parameters__block\">\r\n            <div class=\"row\">\r\n              <div class=\"col-md-12 MB-10 PLR-0\">\r\n                <div class=\" MB-10\">\r\n                  <span class=\"primary-color fw-500\">View Body</span>\r\n                  <span class=\"primary-color fw-500 on-right cursor-pointer\" (click)=\"onPreviewDialog()\">Preview</span>\r\n                </div>\r\n                <!--<angular-editor formControlName=\"content\" [config]=\"config\"></angular-editor>-->\r\n                <editor formControlName=\"content\"\r\n                        [init]=\"{'menubar': 'false', 'height': 460, 'relative_urls': false, 'remove_script_host': false, 'convert_urls': true}\"></editor>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class=\"col-md-12 MTB-20\">\r\n          <div class=\"row\">\r\n            <div class=\"col-md-12 text-right PR-0\">\r\n              <button type=\"submit\" class=\"btn-primary\" [disabled]=\"emailParametersForm.invalid\">Submit</button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </form>\r\n    </div>\r\n  </div>\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.scss":
/*!********************************************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.scss ***!
  \********************************************************************************************************************************************/
/*! no static exports found */
...
module.exports = ".email-parameters__block label {\n  font-weight: 500; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.ts":
/*!******************************************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.ts ***!
  \******************************************************************************************************************************************/
/*! exports provided: DebtorsManagementEmailTemplateComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DebtorsManagementEmailTemplateComponent", function() { return DebtorsManagementEmailTemplateComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _workflow_module_worksheet_module_worksheet_dashboard_action_checklist_email_preview_dialog_checklist_email_preview_dialog_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../workflow-module/worksheet-module/worksheet-dashboard-action/checklist-email-preview-dialog/checklist-email-preview-dialog.component */ "./src/app/admin/workflow-module/worksheet-module/worksheet-dashboard-action/checklist-email-preview-dialog/checklist-email-preview-dialog.component.ts");
...
var DebtorsManagementEmailTemplateComponent = /** @class */ (function (_super) {
    __extends(DebtorsManagementEmailTemplateComponent, _super);
    function DebtorsManagementEmailTemplateComponent(_fb, _router, _commonCrudService, _sharedService, _sharedObjService, dialog) {
        var _this = _super.call(this) || this;
        _this._fb = _fb;
        ...
        _this.debtorsTemplate = [];
        _this.selectedUser = [];
        _this.validationMsg = new _utility_validation__WEBPACK_IMPORTED_MODULE_11__["ValidationConstantMessage"]();
        _this.userList = [];
        _this.show = false;
        _this.billingID = _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_4__["INVOICEPDFDATA"].BILLINGID;
        return _this;
    }
    DebtorsManagementEmailTemplateComponent.prototype.ngOnInit = function () {
        var DMData = this._sharedService.getClientData(_utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_4__["GLOBALDATAKEYS"].DEBTORS_MANAGEMENT);
     ...
     * Email Form
     */
    DebtorsManagementEmailTemplateComponent.prototype.emailForm = function () {
        this.emailParametersForm = this._fb.group({
            from_email: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.billingID, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required),
            entity_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.debtorsManagement.entity_id),
            to: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.debtorsManagement.to_email, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required),
            cc: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.debtorsManagement.cc_email),
            ...
            template_type: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required)
        });
    };
    /**
     * Get User List
     */
    DebtorsManagementEmailTemplateComponent.prototype.getUserList = function () {
        var _this = this;
        this._sharedObjService.getUserList({ 'records': 'all' }, { 'compare': { 'equal': { 'is_active': 1 } } }).subscribe(function (response) {
            _this.userList = response;
        });
     ...
     */
    DebtorsManagementEmailTemplateComponent.prototype.getDebtorsTemplateList = function () {
        var _this = this;
        this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_8__["AdminAPI"].DEBTORS_MANAGEMENT_TEMPLATE_LIST, { 'records': 'all' }, {}).subscribe(function (response) {
            if (response) {
                _this.debtorsTemplate = response.payload.data;
            }
        });
    };
    /**
     ...
     * @constructor
     */
    DebtorsManagementEmailTemplateComponent.prototype.OnChangeGetDebtorsTemplateData = function (template_id) {
        var _this = this;
        this._commonCrudService.getData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_8__["AdminAPI"].DEBTORS_MANAGEMENT_MAIL_DATA, 0, {
            'entity_id': this.debtorsManagement.entity_id,
            'template_id': template_id
        }).subscribe(function (response) {
            if (response) {
                (response.payload.subject) ? _this.emailParametersForm.get('subject').setValue(response.payload.subject) : _this.emailParametersForm.get('subject').setValue(null);
                (response.payload.content) ? _this.emailParametersForm.get('content').setValue(response.payload.content) : _this.emailParametersForm.get('content').setValue(null);
            }
        });
    };
    /**
     ...
     */
    DebtorsManagementEmailTemplateComponent.prototype.submitDebtorsForm = function (form) {
        var _this = this;
        if (form.valid) {
            var formValue = {};
            var bccEmail = '';
            ...
            this._commonCrudService.addData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_8__["AdminAPI"].DEBTORS_MANAGEMENT_LIST, formValue).subscribe(function (response) {
                _this.onDebtorsManagement();
            });
        }
    };
    /**
     ...
     */
    DebtorsManagementEmailTemplateComponent.prototype.onDebtorsManagement = function () {
        this._router.navigate(['/' + _utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_3__["AdminRoutes"].DEBTORS_MANAGEMENT]);
    };
    DebtorsManagementEmailTemplateComponent.prototype.showBcc = function () {
        this.show = !this.show;
    };
    DebtorsManagementEmailTemplateComponent.prototype.handleEvent = function (event) {
        // console.log(event);
    };
    /**
     * On home page route
     */
    DebtorsManagementEmailTemplateComponent.prototype.onGoDashboard = function () {
        this._router.navigate(['/' + _utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_3__["AdminRoutes"].ADMIN_NEW_HRMS]);
    };
    /**
     * On Previewe Dialog
     */
    DebtorsManagementEmailTemplateComponent.prototype.onPreviewDialog = function () {
        var contentData = tinymce.activeEditor.getContent();
        // console.log(contentData);
        var dialogRef = this.dialog.open(_workflow_module_worksheet_module_worksheet_dashboard_action_checklist_email_preview_dialog_checklist_email_preview_dialog_component__WEBPACK_IMPORTED_MODULE_9__["ChecklistEmailPreviewDialogComponent"], {
    ...
    DebtorsManagementEmailTemplateComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-debtors-management-email-template',
            template: __webpack_require__(/*! ./debtors-management-email-template.component.html */ "./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.html"),
            styles: [__webpack_require__(/*! ./debtors-management-email-template.component.scss */ "./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _utility_shared_service_common_crud_service__WEBPACK_IMPORTED_MODULE_5__["CommonCrudService"],
            _utility_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_6__["SharedService"],
            _utility_shared_service_shared_object_service__WEBPACK_IMPORTED_MODULE_7__["SharedObjService"], _angular_material__WEBPACK_IMPORTED_MODULE_10__["MatDialog"]])
    ], DebtorsManagementEmailTemplateComponent);
    return DebtorsManagementEmailTemplateComponent;
...
/***/ "./src/app/admin/billing-module/debtors-management/debtors-management.component.html":
/*!*******************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/debtors-management.component.html ***!
  \*******************************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"debtors-management-container\">\r\n  <!-- Start BreadCrumb Top Header -->\r\n  <div class=\"breadcrumb-top-header\">\r\n    <div class=\"row\">\r\n      <div class=\"col-md-12 PL-0\">\r\n        <div class=\"breadcrumb-top-header__breadcrumbs\">\r\n          <mat-icon class=\"material-icons cursor-pointer\"><a (click)=\"onGoDashboard()\">home</a></mat-icon>\r\n\r\n          <mat-icon class=\"material-icons\">keyboard_arrow_right</mat-icon>\r\n          <span>BILLNG</span>\r\n\r\n          <mat-icon class=\"material-icons\">keyboard_arrow_right</mat-icon>\r\n          <span class=\"active\">DEBTORS MANAGEMENT</span>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <!-- End BreadCrumb Top Header -->\r\n  <!-- Start Data Grid -->\r\n  <div class=\"with-filter-grid-container\">\r\n    <!-- Start Grid Inner Header -->\r\n    <div class=\"grid-inner-header\">\r\n      <div class=\"row\">\r\n        <div class=\"col-md-6 inner-header-title\">\r\n          <button type=\"button\" class=\"open-dialog-btn\" (click)=\"runCronToUpdateDebtors()\" *ngIf=\"moveToDebtors\">\r\n            <i class=\"material-icons\">chevron_right</i> Run Cron - To Update Debtors\r\n          </button>\r\n        </div>\r\n        <div class=\"col-md-6\">\r\n          <ul class=\"download-icon\">\r\n            <li>\r\n              <a (click)=\"onOpenFilter()\">\r\n                <span>Filter</span>\r\n                <mat-icon class=\"material-icons\">filter_list</mat-icon>\r\n              </a>\r\n            </li>\r\n\r\n            <li>\r\n              <a (click)=\"downloadExcel()\" *ngIf=\"tabData['export']\">\r\n                <span>Excel</span>\r\n                <mat-icon class=\"material-icons\">file_download</mat-icon>\r\n              </a>\r\n            </li>\r\n          </ul>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <!-- End Grid Inner Header -->\r\n\r\n    <!-- Start Grid Filter -->\r\n    <div class=\"filter opacity-0\" [ngClass]=\"{'opacity-1':isOpenFilterView}\">\r\n      <div class=\"filter-action-icon\">\r\n          <span class=\"filter-close\" *ngIf=\"isOpenFilterView\" (click)=\"onCloseFilter()\">Esc <mat-icon\r\n            class=\"material-icons\">close</mat-icon></span>\r\n      </div>\r\n      <div class=\"grid-filter-container\">\r\n        <div class=\"filter-title\">\r\n          <h3>Advance Filter</h3>\r\n        </div>\r\n        <form [formGroup]=\"filterForm\" (submit)=\"setAdvanceFilter(filterForm)\">\r\n          <div class=\"row\">\r\n            <div class=\"col-md-3 MT-10\">\r\n              <ng-select [items]=\"invoiceNo\"\r\n                         [closeOnSelect]=\"true\"\r\n                         bindLabel=\"invoice_no\"\r\n                         placeholder=\"Invoice No\"\r\n                         bindValue=\"invoice_no\"\r\n                         [virtualScroll]=\"true\"\r\n                         [searchable]=\"true\"\r\n                         [hideSelected]=\"true\"\r\n                         formControlName=\"invoice_no\">\r\n              </ng-select>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <input matInput placeholder=\"Billing Name\" formControlName=\"billing_name\">\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <mat-select placeholder=\"Service\" formControlName=\"service_id\">\r\n                  <mat-option *ngFor=\"let service of serviceList\" [value]=\"service?.id\">\r\n                    {{ service?.service_name }}\r\n                  </mat-option>\r\n                </mat-select>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <ng-select [items]=\"tamList\"\r\n                         [closeOnSelect]=\"true\"\r\n                         bindLabel=\"userfullname\"\r\n                         placeholder=\"TAM\"\r\n                         bindValue=\"id\"\r\n                         [virtualScroll]=\"true\"\r\n                         [searchable]=\"true\"\r\n                         [hideSelected]=\"true\"\r\n                         formControlName=\"tam\">\r\n              </ng-select>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"periodfromdate\" placeholder=\"Period From\"\r\n                       formControlName=\"from_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"periodfromdate\"></mat-datepicker-toggle>\r\n                <mat-datepicker #periodfromdate></mat-datepicker>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"periodtodate\" placeholder=\"Period To\" formControlName=\"to_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"periodtodate\"></mat-datepicker-toggle>\r\n                <mat-datepicker #periodtodate></mat-datepicker>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <mat-select placeholder=\"Fixed fee\" formControlName=\"is_fixed_fees\">\r\n                  <mat-option *ngFor=\"let ff of fixedFeeList.slice(1)\" [value]=\"ff?.key\">\r\n                    {{ ff?.label}}\r\n                  </mat-option>\r\n                </mat-select>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <mat-select placeholder=\"Payment Type\" formControlName=\"payment_id\">\r\n                  <mat-option *ngFor=\"let payment of paymentList\" [value]=\"payment?.key\">\r\n                    {{ payment?.label}}\r\n                  </mat-option>\r\n                </mat-select>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"sentfromdate\" placeholder=\"Sent Date From\"\r\n                       formControlName=\"sent_from_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"sentfromdate\"></mat-datepicker-toggle>\r\n                <mat-datepicker #sentfromdate></mat-datepicker>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"senttodate\" placeholder=\"Sent Date To\" formControlName=\"sent_to_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"senttodate\"></mat-datepicker-toggle>\r\n                <mat-datepicker #senttodate></mat-datepicker>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"duefromdate\" placeholder=\"Due Date From\"\r\n                       formControlName=\"due_from_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"duefromdate\"></mat-datepicker-toggle>\r\n                <mat-datepicker #duefromdate></mat-datepicker>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"duetodate\" placeholder=\"Due Date To\" formControlName=\"due_to_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"duetodate\"></mat-datepicker-toggle>\r\n                <mat-datepicker #duetodate></mat-datepicker>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <ng-select [items]=\"userList\"\r\n                         [closeOnSelect]=\"true\"\r\n                         bindLabel=\"userfullname\"\r\n                         placeholder=\"Created By\"\r\n                         bindValue=\"id\"\r\n                         [virtualScroll]=\"true\"\r\n                         [searchable]=\"true\"\r\n                         [hideSelected]=\"true\"\r\n                         formControlName=\"created_by\">\r\n              </ng-select>\r\n            </div>\r\n\r\n            <div class=\"col-md-3 MT-10\">\r\n              <mat-form-field>\r\n                <mat-select placeholder=\"Follow Up\" formControlName=\"debtor_followup\">\r\n                  <mat-option *ngFor=\"let ff of fixedFeeList.slice(1)\" [value]=\"ff?.key\">\r\n                    {{ ff?.label}}\r\n                  </mat-option>\r\n                </mat-select>\r\n              </mat-form-field>\r\n            </div>\r\n\r\n            <div class=\"col-md-6 MT-10 text-right\">\r\n              <button type=\"button\" class=\"btn-cancel\" (click)=\"resetFilterForm()\">Clear</button>\r\n              <button type=\"submit\" class=\"btn-primary\">Search</button>\r\n            </div>\r\n          </div>\r\n        </form>\r\n      </div>\r\n    </div>\r\n    <!-- End Grid Filter -->\r\n\r\n    <!-- Start Filter Tags -->\r\n    <div class=\"filter-tags\">\r\n      <form [formGroup]=\"advanceFilterForm\">\r\n        <div class=\"tag\" *ngIf=\"invoiceNoField.value\">\r\n          <span class=\"tag__title\">Invoice No :</span>\r\n          <span>\r\n             <ng-select [items]=\"invoiceNo\"\r\n                        [closeOnSelect]=\"true\"\r\n                        bindLabel=\"invoice_no\"\r\n                        placeholder=\"Invoice No\"\r\n                        bindValue=\"invoice_no\"\r\n                        [virtualScroll]=\"true\"\r\n                        [searchable]=\"true\"\r\n                        [hideSelected]=\"true\"\r\n                        formControlName=\"invoice_no\"\r\n                        (change)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\">\r\n              </ng-select>\r\n            </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('invoice_no')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"entityIdField.value\">\r\n          <span class=\"tag__title\">Billing Name :</span>\r\n          <span>\r\n               <mat-form-field>\r\n                <input matInput placeholder=\"Billing Name\" formControlName=\"billing_name\"\r\n                       (keyup)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\">\r\n              </mat-form-field>\r\n              </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('billing_name')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"serviceIDField.value\">\r\n          <span class=\"tag__title\">Service :</span>\r\n          <span>\r\n                <mat-form-field>\r\n                  <mat-select placeholder=\"Service\" #selectRef\r\n                              (selectionChange)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\" readonly\r\n                              formControlName=\"service_id\">\r\n                  <mat-option *ngFor=\"let service of serviceList\" [value]=\"service?.id\">\r\n                    {{ service?.service_name }}\r\n                  </mat-option>\r\n                  </mat-select>\r\n                </mat-form-field>\r\n              </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('service_id')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"tamField.value\">\r\n          <span class=\"tag__title\">TAM:</span>\r\n          <span>\r\n            <ng-select [items]=\"tamList\"\r\n                       [closeOnSelect]=\"true\"\r\n                       bindLabel=\"userfullname\"\r\n                       placeholder=\"TAM\"\r\n                       bindValue=\"id\"\r\n                       [virtualScroll]=\"true\"\r\n                       [searchable]=\"true\"\r\n                       [hideSelected]=\"true\"\r\n                       formControlName=\"tam\"\r\n                       (change)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\">\r\n              </ng-select>\r\n          </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('tam')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"fromDateField.value\">\r\n          <span class=\"tag__title\">Period From:</span>\r\n          <span>\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"periodfromdate1\" placeholder=\"Period From\" #dateRef\r\n                       formControlName=\"from_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"periodfromdate1\"></mat-datepicker-toggle>\r\n                <mat-datepicker #periodfromdate1></mat-datepicker>\r\n              </mat-form-field>\r\n            </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('from_date')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"toDateField.value\">\r\n          <span class=\"tag__title\">Period To:</span>\r\n          <span>\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"periodtodate1\" placeholder=\"Period To\" #dateRef\r\n                       formControlName=\"to_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"periodtodate1\"></mat-datepicker-toggle>\r\n                <mat-datepicker #periodtodate1></mat-datepicker>\r\n              </mat-form-field>\r\n            </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('to_date')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"fixedFeeField.value !== null\">\r\n          <span class=\"tag__title\">Fixed fee :</span>\r\n          <span>\r\n                <mat-form-field>\r\n                  <mat-select placeholder=\"Fixed Fee\" #selectRef\r\n                              (selectionChange)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\" readonly\r\n                              formControlName=\"is_fixed_fees\">\r\n                  <mat-option *ngFor=\"let ff of fixedFeeList.slice(1)\" [value]=\"ff?.key\">\r\n                    {{ ff?.label}}\r\n                  </mat-option>\r\n                  </mat-select>\r\n                </mat-form-field>\r\n              </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('is_fixed_fees')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"paymentIDField.value\">\r\n          <span class=\"tag__title\">Payment Type :</span>\r\n          <span>\r\n                <mat-form-field>\r\n                  <mat-select placeholder=\"select\" #selectRef\r\n                              (selectionChange)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\" readonly\r\n                              formControlName=\"payment_id\">\r\n                    <mat-option *ngFor=\"let payment of paymentList\" [value]=\"payment?.key\">\r\n                    {{ payment?.label}}\r\n                  </mat-option>\r\n                  </mat-select>\r\n                </mat-form-field>\r\n              </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('payment_id')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"sentFromField.value\">\r\n          <span class=\"tag__title\">Sent From:</span>\r\n          <span>\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"sentfromdate1\" placeholder=\"Sent From\" #dateRef\r\n                       formControlName=\"sent_from_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"sentfromdate1\"></mat-datepicker-toggle>\r\n                <mat-datepicker #sentfromdate1></mat-datepicker>\r\n              </mat-form-field>\r\n            </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('sent_from_date')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"sentToField.value\">\r\n          <span class=\"tag__title\">Sent To:</span>\r\n          <span>\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"senttodate1\" placeholder=\"Sent To\" #dateRef\r\n                       formControlName=\"sent_to_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"senttodate1\"></mat-datepicker-toggle>\r\n                <mat-datepicker #senttodate1></mat-datepicker>\r\n              </mat-form-field>\r\n            </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('sent_to_date')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"dueFromField.value\">\r\n          <span class=\"tag__title\">Due Date From:</span>\r\n          <span>\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"duefromdate1\" placeholder=\"Due Date From\" #dateRef\r\n                       formControlName=\"due_from_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"duefromdate1\"></mat-datepicker-toggle>\r\n                <mat-datepicker #duefromdate1></mat-datepicker>\r\n              </mat-form-field>\r\n            </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('due_from_date')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"dueToField.value\">\r\n          <span class=\"tag__title\">Due Date To:</span>\r\n          <span>\r\n              <mat-form-field>\r\n                <input matInput [matDatepicker]=\"duetodate1\" placeholder=\"Due Date To\" #dateRef\r\n                       formControlName=\"due_to_date\">\r\n                <mat-datepicker-toggle matSuffix [for]=\"duetodate1\"></mat-datepicker-toggle>\r\n                <mat-datepicker #duetodate1></mat-datepicker>\r\n              </mat-form-field>\r\n            </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('due_to_date')\">close</mat-icon>\r\n        </div>\r\n\r\n        <div class=\"tag\" *ngIf=\"createdByField.value\">\r\n          <span class=\"tag__title\">Created By :</span>\r\n          <span>\r\n                <ng-select [items]=\"userList\"\r\n                           [closeOnSelect]=\"true\"\r\n                           bindLabel=\"userfullname\"\r\n                           placeholder=\"Created By\"\r\n                           bindValue=\"id\"\r\n                           [virtualScroll]=\"true\"\r\n                           [searchable]=\"true\"\r\n                           [hideSelected]=\"true\"\r\n                           formControlName=\"created_by\"\r\n                           (change)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\">\r\n              </ng-select>\r\n              </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('created_by')\">close</mat-icon>\r\n        </div>\r\n\r\n\r\n        <div class=\"tag\" *ngIf=\"debtosFollowupField.value !== null\">\r\n          <span class=\"tag__title\">Follow Up :</span>\r\n          <span>\r\n                <mat-form-field>\r\n                  <mat-select placeholder=\"Follow Up\" #selectRef\r\n                              (selectionChange)=\"setAdvanceFilterKeyUp($event, advanceFilterForm, true)\" readonly\r\n                              formControlName=\"debtor_followup\">\r\n                  <mat-option *ngFor=\"let ff of fixedFeeList.slice(1)\" [value]=\"ff?.key\">\r\n                    {{ ff?.label}}\r\n                  </mat-option>\r\n                  </mat-select>\r\n                </mat-form-field>\r\n              </span>\r\n          <mat-icon class=\"material-icons tag__close\" (click)=\"onClearTag('debtor_followup')\">close</mat-icon>\r\n        </div>\r\n\r\n\r\n        <div class=\"clearAll-tags\"\r\n             *ngIf=\"entityIdField.value || invoiceNoField.value || createdByField.value || serviceIDField.value\r\n                    || fixedFeeField.value !== null || paymentIDField.value || fromDateField.value || toDateField.value\r\n                    || sentFromField.value || sentToField.value || dueFromField.value || dueToField.value\r\n                    || debtosFollowupField.value !== null\">\r\n          <a (click)=\"resetFilterForm()\">Clear all</a>\r\n        </div>\r\n      </form>\r\n    </div>\r\n    <!-- End Filter Tags -->\r\n\r\n    <!-- Start Table -->\r\n    <div class=\"table-container\">\r\n      <div class=\"table-block scrollable-grid\">\r\n        <table>\r\n          <thead>\r\n          <tr>\r\n            <th width=\"5%\">Sr. No</th>\r\n\r\n            <th width=\"8%\"\r\n                (click)=\"getSortData('invoice_no', sortBy === 'invoice_no' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Invoice No\r\n              <i *ngIf=\"sortBy === 'invoice_no'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'invoice_no' && sortOrder === 'asc', 'icon-down' :  sortBy === 'invoice_no' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'invoice_no' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"10%\"\r\n                (click)=\"getSortData('billing_name', sortBy === 'billing_name' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Billing Name\r\n              <i *ngIf=\"sortBy === 'billing_name'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'billing_name' && sortOrder === 'asc', 'icon-down' :  sortBy === 'billing_name' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'billing_name' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"10%\"\r\n                (click)=\"getSortData('service_name', sortBy === 'service_name' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Service\r\n              <i *ngIf=\"sortBy === 'service_name'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'service_name' && sortOrder === 'asc', 'icon-down' :  sortBy === 'service_name' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'service_name' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('tam_name', sortBy === 'tam_name' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              TAM\r\n              <i *ngIf=\"sortBy === 'tam_name'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'tam_name' && sortOrder === 'asc', 'icon-down' :  sortBy === 'tam_name' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'tam_name' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('is_fixed_fees', sortBy === 'is_fixed_fees' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Fixed Fee\r\n              <i *ngIf=\"sortBy === 'is_fixed_fees'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'is_fixed_fees' && sortOrder === 'asc', 'icon-down' :  sortBy === 'is_fixed_fees' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'is_fixed_fees' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('tam_name', sortBy === 'tam_name' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              TAM\r\n              <i *ngIf=\"sortBy === 'tam_name'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'tam_name' && sortOrder === 'asc', 'icon-down' :  sortBy === 'tam_name' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'tam_name' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('paid_amount', sortBy === 'paid_amount' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Amount (Inc GST)\r\n              <i *ngIf=\"sortBy === 'paid_amount'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'paid_amount' && sortOrder === 'asc', 'icon-down' :  sortBy === 'paid_amount' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'paid_amount' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"8%\"\r\n                (click)=\"getSortData('outstanding_amount', sortBy === 'outstanding_amount' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Due Amount (Inc GST)\r\n              <i *ngIf=\"sortBy === 'outstanding_amount'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'outstanding_amount' && sortOrder === 'asc', 'icon-down' :  sortBy === 'outstanding_amount' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'outstanding_amount' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('payment_id', sortBy === 'payment_id' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Payment Type\r\n              <i *ngIf=\"sortBy === 'payment_id'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'payment_id' && sortOrder === 'asc', 'icon-down' :  sortBy === 'payment_id' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'payment_id' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('send_date', sortBy === 'send_date' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Sent Date\r\n              <i *ngIf=\"sortBy === 'send_date'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'send_date' && sortOrder === 'asc', 'icon-down' :  sortBy === 'send_date' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'send_date' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('due_date', sortBy === 'due_date' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Due Date\r\n              <i *ngIf=\"sortBy === 'due_date'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'due_date' && sortOrder === 'asc', 'icon-down' :  sortBy === 'due_date' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'due_date' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('created_by', sortBy === 'created_by' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Created By\r\n              <i *ngIf=\"sortBy === 'created_by'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'created_by' && sortOrder === 'asc', 'icon-down' :  sortBy === 'created_by' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'created_by' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n\r\n            <th width=\"7%\"\r\n                (click)=\"getSortData('debtor_followup', sortBy === 'debtor_followup' ? (sortOrder === 'asc' ? 'desc' : 'asc') : 'asc')\">\r\n              Follow Up\r\n              <i *ngIf=\"sortBy === 'debtor_followup'\"\r\n                 [ngClass]=\"{'material-icons': true, 'icon-up' : sortBy === 'debtor_followup' && sortOrder === 'asc', 'icon-down' :  sortBy === 'debtor_followup' && sortOrder === 'desc'}\">\r\n                {{sortBy === 'debtor_followup' ? (sortOrder === 'asc' ? 'arrow_upward':'arrow_downward') : ''}}\r\n              </i>\r\n            </th>\r\n            <th width=\"5%\">Action</th>\r\n          </tr>\r\n          </thead>\r\n        </table>\r\n        <div class=\"table-body\">\r\n          <table *ngIf=\"debtorsManagement.length\">\r\n            <tbody>\r\n            <tr *ngFor=\"let debtors of debtorsManagement; let i = index\">\r\n              <td width=\"5%\">{{+pageSize * (pageIndex) + i + 1}}\r\n                <mat-icon class=\"red-color v-align-middle\" *ngIf=\"debtors?.discontinue_stage === 1\"\r\n                          [matTooltip]=\"'Discontinue Process Initiated'\">block\r\n                </mat-icon>\r\n              </td>\r\n              <td width=\"8%\">{{debtors?.invoice_no}}</td>\r\n              <td width=\"10%\">{{debtors?.billing_name}}</td>\r\n              <td width=\"10%\">{{debtors?.service_name}} <br> {{debtors?.from_period !== '0000-00-00' ?\r\n                (debtors?.from_period |\r\n                date : 'dd-MM-yyyy' + ' to ') : 'till '}}{{debtors?.to_period | date : 'dd-MM-yyyy'}}\r\n              </td>\r\n              <td width=\"7%\">{{debtors?.tam_name}}</td>\r\n              <td width=\"7%\">\r\n                <span class=\"turquoise-color fw-500\" *ngIf=\"debtors?.is_fixed_fees == 1\"><mat-icon\r\n                  class=\"grid_icon_trip_origin mat-icon material-icons\">trip_origin</mat-icon>Yes</span>\r\n                <span class=\"red-color fw-500\" *ngIf=\"debtors?.is_fixed_fees !== 1\"><mat-icon\r\n                  class=\"grid_icon_trip_origin mat-icon material-icons\">trip_origin</mat-icon>No</span>\r\n              </td>\r\n              <td width=\"7%\">{{debtors?.tam_name}}</td>\r\n              <td width=\"7%\">{{debtors?.paid_amount}}</td>\r\n              <td width=\"8%\">{{debtors?.outstanding_amount}}</td>\r\n              <td width=\"7%\">{{getPaymentType(debtors?.payment_id)}}</td>\r\n              <td width=\"7%\">{{debtors?.send_date | date : 'dd-MM-yyyy' }}</td>\r\n              <td width=\"7%\">{{debtors?.due_date | date : 'dd-MM-yyyy'}}</td>\r\n              <td width=\"7%\">{{debtors?.created_by?.userfullname}}</td>\r\n              <td width=\"7%\">\r\n                <span class=\"turquoise-color fw-500\" *ngIf=\"debtors?.debtor_followup === 1\"><mat-icon\r\n                  class=\"grid_icon_trip_origin mat-icon material-icons\">trip_origin</mat-icon>Yes</span>\r\n                <span class=\"red-color fw-500\" *ngIf=\"debtors?.debtor_followup !== 1\"><mat-icon\r\n                  class=\"grid_icon_trip_origin mat-icon material-icons\">trip_origin</mat-icon>No</span>\r\n              </td>\r\n              <td width=\"5%\">\r\n                <ul>\r\n                  <li>\r\n                    <a>\r\n                      <mat-icon [matMenuTriggerFor]=\"menuaction\">more_vert</mat-icon>\r\n                      <a *ngIf=\"debtors?.related_entity === 1 && debtors['is_button_show'] === 1\"\r\n                         (click)=\"onSeparateInvoiceDialog(debtors)\" class=\"orange-color\"\r\n                         [matTooltip]=\"'Separate Invoice'\"><i\r\n                        class=\"material-icons\">flag</i></a>\r\n                      <mat-menu #menuaction=\"matMenu\" class=\"column-menu\">\r\n                        <button mat-menu-item class=\"menu-header\">\r\n                          <h3>Action</h3>\r\n                        </button>\r\n                        <button mat-menu-item *ngIf=\"tabData['add_edit'] && debtors['is_button_show'] === 1\"\r\n                                (click)=\"onAddCommentDialog(debtors)\">\r\n                          <mat-icon>comment</mat-icon>\r\n                          Comments\r\n                        </button>\r\n                        <button mat-menu-item *ngIf=\"tabData['add_edit'] && debtors['is_button_show'] === 1\"\r\n                                (click)=\"onDMEmailTemplate(debtors)\">\r\n                          <mat-icon>email</mat-icon>\r\n                          Send Mail\r\n                        </button>\r\n                        <button mat-menu-item *ngIf=\"tabInvoiceData['view']\"\r\n                                (click)=\"invoiceSendToClientPreview(debtors?.id)\">\r\n                          <mat-icon>remove_red_eye</mat-icon>\r\n                          View Invoice\r\n                        </button>\r\n                        <!--<button mat-menu-item *ngIf=\"tabClientData['add_edit'] && debtors['is_button_show'] === 1\"\r\n                                (click)=\"onUpdateClient(debtors?.entity_id)\">\r\n                          <a [target]=\"'_blank'\">\r\n                            <mat-icon>edit</mat-icon>\r\n                            Edit Entity</a>\r\n                        </button>-->\r\n                      </mat-menu>\r\n                    </a>\r\n                  </li>\r\n                </ul>\r\n              </td>\r\n            </tr>\r\n            </tbody>\r\n          </table>\r\n        </div>\r\n\r\n        <table *ngIf=\"debtorsManagement.length\">\r\n          <tfoot>\r\n          <tr>\r\n            <td colspan=\"3\" class=\"total_units\">\r\n              <label>Total Due Amount:</label> <span class=\"primary-color ML-10\">{{totalAmount}}</span>\r\n            </td>\r\n            <td colspan=\"10\">\r\n              <mat-paginator [length]=\"totalRecords\"\r\n                             [pageSize]=\"pageSize\"\r\n                             [pageIndex]=\"pageIndex\"\r\n                             [pageSizeOptions]=\"pageArray\"\r\n                             (page)=\"onPageChange($event)\">\r\n              </mat-paginator>\r\n            </td>\r\n          </tr>\r\n          </tfoot>\r\n        </table>\r\n      </div>\r\n    </div>\r\n    <!-- End Table -->\r\n  </div>\r\n  <div *ngIf=\"debtorsManagement.length === 0\" class=\"panel-title red-color\">\r\n    No Records Found!\r\n  </div>\r\n  <!-- End Data Grid -->\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/debtors-management.component.scss":
/*!*******************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/debtors-management.component.scss ***!
  \*******************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJwcm9qZWN0cy9hZG1pbi9zcmMvYXBwL2FkbWluL2JpbGxpbmctbW9kdWxlL2RlYnRvcnMtbWFuYWdlbWVudC9kZWJ0b3JzLW1hbmFnZW1lbnQuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/debtors-management.component.ts":
/*!*****************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/debtors-management.component.ts ***!
  \*****************************************************************************************/
/*! exports provided: DebtorsManagementComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DebtorsManagementComponent", function() { return DebtorsManagementComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "../../node_modules/@angular/forms/fesm5/forms.js");
...
/* harmony import */ var _add_comments_dialog_add_comments_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./add-comments-dialog/add-comments-dialog.component */ "./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.ts");
/* harmony import */ var _separate_invoice_dialog_separate_invoice_dialog_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./separate-invoice-dialog/separate-invoice-dialog.component */ "./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.ts");
...
/* harmony import */ var _utility_pipe_noComma_pipe__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../../utility/pipe/noComma.pipe */ "./src/utility/pipe/noComma.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DebtorsManagementComponent = /** @class */ (function () {
    function DebtorsManagementComponent(_fb, _router, dialog, _commonCrudService, _sharedService, _decimalPipe, _noCommaPipe, _sharedObjService) {
        this._fb = _fb;
        ...
        this.title = 'app';
        // Data Variables
        this.debtorsManagement = [];
        this.serviceList = [];
        this.userList = [];
        this.fixedFeeList = _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_8__["yesNo"];
        this.paymentList = _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_8__["payment"];
        this.equalJSON = {};
        this.likeJSON = {};
        this.inJSON = {};
        this.clientList = [];
        ...
        this.totalAmount = 0;
        this.tamList = [];
        this.tabID = _utility_constants_header_constant__WEBPACK_IMPORTED_MODULE_14__["ADMINTABACCESS"].BILLING_DEBTORSMANAGEMENT;
        this.tabClientID = _utility_constants_header_constant__WEBPACK_IMPORTED_MODULE_14__["ADMINTABACCESS"].CLIENT_VIEWCLIENT;
        this.tabInvoiceID = _utility_constants_header_constant__WEBPACK_IMPORTED_MODULE_14__["ADMINTABACCESS"].BILLING_INVOICE;
        this.moveToDebtors = false;
    }
    Object.defineProperty(DebtorsManagementComponent.prototype, "tamField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "entityIdField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "invoiceNoField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "serviceIDField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "fixedFeeField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "paymentIDField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "fromDateField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "toDateField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "sentFromField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "sentToField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "dueFromField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "dueToField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "createdByField", {
        get: function () {
    ...
    Object.defineProperty(DebtorsManagementComponent.prototype, "debtosFollowupField", {
        get: function () {
    ...
    DebtorsManagementComponent.prototype.ngOnInit = function () {
     ...
     */
    DebtorsManagementComponent.prototype.initializationMethod = function () {
        var _this = this;
        ...
        this.getServices();
        this.getUserList();
        this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_9__["AdminAPI"].DEBTORS_MANAGEMENT_LIST, { 'records': 'all' }).subscribe(function (response) {
            var invoiceNoList = response.payload.data;
            _this.invoiceNo = Array.from(new Set(invoiceNoList.map(function (item) { return item.invoice_no; })));
        });
    };
    /**
     * Create Form for filters
     */
    DebtorsManagementComponent.prototype.createAdvanceFilterForm = function () {
        this.filterForm = this._fb.group({
            invoice_no: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            billing_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            service_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            is_fixed_fees: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            payment_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            ...
            sent_from_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            sent_to_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            due_from_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            due_to_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            created_by: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            debtor_followup: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
            tam: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
        });
     ...
     * Get Client List
     */
    DebtorsManagementComponent.prototype.getClientList = function () {
        var _this = this;
        this._sharedObjService.getClientList({ 'records': 'all', 'discountinue_stage': '2' }, {}).subscribe(function (response) {
     ...
     * Get Service List
     */
    DebtorsManagementComponent.prototype.getServices = function () {
        var _this = this;
     ...
     * Get User List
     */
    DebtorsManagementComponent.prototype.getUserList = function () {
        var _this = this;
        this._sharedObjService.getUserList({ 'records': 'all' }, { 'compare': { 'equal': { 'is_active': 1 } } }).subscribe(function (response) {
            _this.userList = response;
     ...
     * @param {string} val
     */
    DebtorsManagementComponent.prototype.getDebtorsManagementList = function (pageNumber, key, val) {
        var _this = this;
        this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_9__["AdminAPI"].DEBTORS_MANAGEMENT_LIST, this.getQueryParams(pageNumber, key, val), this.getSearchParam()).subscribe(function (response) {
            _this.handleDebstorsManagementResponse(response);
        });
    };
    /**
     ...
     * @param response
     */
    DebtorsManagementComponent.prototype.handleDebstorsManagementResponse = function (response) {
        var _this = this;
        this.debtorsManagement = response.payload.data;
        var entity_id_list = [];
        this.totalAmount = 0;
        this.debtorsManagement.map(function (item) {
            var itemData = entity_id_list.indexOf(item.invoice_no);
            if (itemData >= 0) {
            ...
            _this.totalAmount += (+item.outstanding_amount);
     ...
     * Toogle Filter
     */
    DebtorsManagementComponent.prototype.onOpenFilter = function () {
        this.isOpenFilterView = !this.isOpenFilterView;
    };
    /**
     * Close filter
     */
    DebtorsManagementComponent.prototype.onCloseFilter = function () {
        this.isOpenFilterView = false;
    };
    /**
     ...
     * @param event
     */
    DebtorsManagementComponent.prototype.onPageChange = function (event) {
        this.pageSize = event.pageSize;
     ...
     * Export to Excel
     */
    DebtorsManagementComponent.prototype.downloadExcel = function () {
        var params = { 'excel': 1, 'records': 'all' };
        if (this.tamField.value) {
            params['technical_account_manager'] = this.tamField.value;
        }
        this._commonCrudService.downloadExcelData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_9__["AdminAPI"].DEBTORS_MANAGEMENT_LIST_EXPORT_EXCEL, params, this.getSearchParam(), 'Debtors Management  ', 0).subscribe(function (response) {
        });
    };
    /**
     ...
     * @param debtors
     */
    DebtorsManagementComponent.prototype.onAddCommentDialog = function (debtors) {
        var dialogRef = this.dialog.open(_add_comments_dialog_add_comments_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AddCommentsDialogComponent"], {
            panelClass: 'lg-dialog--container',
            data: {
                debtorsData: debtors
            }
     ...
     * @param debtors
     */
    DebtorsManagementComponent.prototype.onDMEmailTemplate = function (debtors) {
        this._sharedService.setClientData(_utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_8__["GLOBALDATAKEYS"].DEBTORS_MANAGEMENT, debtors);
        window.open(_utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_5__["AdminRoutes"].DEBTORS_MANAGEMENT_EMAIL_TEMPLATE, '_blank');
    };
    /**
     * On Click of Related Entity Separate Invoice Dialog
     */
    DebtorsManagementComponent.prototype.onSeparateInvoiceDialog = function (debtors) {
        var dialogRef = this.dialog.open(_separate_invoice_dialog_separate_invoice_dialog_component__WEBPACK_IMPORTED_MODULE_7__["SeparateInvoiceDialogComponent"], {
            panelClass: 'lg-dialog--container',
            data: {
                debtorsData: debtors
            }
    ...
    DebtorsManagementComponent.prototype.onKeydownHandler = function (event) {
        if (event.keyCode === 27) {
            this.isOpenFilterView = false;
        }
    };
     ...
     */
    DebtorsManagementComponent.prototype.onClearTag = function (elementName, JsonElementName) {
     ...
     * Reset All Filters
     */
    DebtorsManagementComponent.prototype.resetFilterForm = function () {
        this.createAdvanceFilterForm();
        this.likeJSON = {};
        this.equalJSON = {};
        this.inJSON = {};
     ...
     * @param {boolean} flag
     */
    DebtorsManagementComponent.prototype.setAdvanceFilterKeyUp = function (event, form, flag) {
     ...
     * @param {boolean} flag
     */
    DebtorsManagementComponent.prototype.setAdvanceFilter = function (form, flag) {
     ...
     * @returns {{}}
     */
    DebtorsManagementComponent.prototype.getQueryParams = function (page, sortKey, sortOrder) {
        var params = {
            pageNumber: page,
            recordsPerPage: this.pageSize
        };
     ...
     */
    DebtorsManagementComponent.prototype.getSortData = function (sortKey, sortVal) {
     ...
     * @returns {{}}
     */
    DebtorsManagementComponent.prototype.getSearchParam = function () {
        var params = {};
        var filter = {};
        ...
        if (this.PeriodFromValue) {
            filter['greaterthanequal']['from_period'] = moment__WEBPACK_IMPORTED_MODULE_13__(this.PeriodFromValue).format('YYYY-MM-DD');
        }
        if (this.PeriodToValue) {
            filter['lessthanequal']['to_period'] = moment__WEBPACK_IMPORTED_MODULE_13__(this.PeriodToValue).format('YYYY-MM-DD');
        }
        if (this.SentFromValue) {
            filter['lessthanequal']['send_date'] = moment__WEBPACK_IMPORTED_MODULE_13__(this.SentFromValue).format('YYYY-MM-DD');
        }
        if (this.SentToValue) {
            filter['greaterthanequal']['send_date'] = moment__WEBPACK_IMPORTED_MODULE_13__(this.SentToValue).format('YYYY-MM-DD');
        }
        if (this.DueFromValue) {
            filter['greaterthanequal']['due_date'] = moment__WEBPACK_IMPORTED_MODULE_13__(this.DueFromValue).format('YYYY-MM-DD');
        }
        if (this.DueToValue) {
            filter['lessthanequal']['due_date'] = moment__WEBPACK_IMPORTED_MODULE_13__(this.DueToValue).format('YYYY-MM-DD');
        }
     ...
     * @returns {string}
     */
    DebtorsManagementComponent.prototype.getPaymentType = function (paymentType) {
        var val = this.paymentList.filter(function (elem) { return elem.key === paymentType; });
        return (val.length) ? val[0].label : '';
    };
    /**
     * Run CRON Move to Update Debtors
     */
    DebtorsManagementComponent.prototype.runCronToUpdateDebtors = function () {
        this._commonCrudService.getData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_9__["AdminAPI"].INVOICE_MOVE_TO_PAID, 0).subscribe(function (Response) {
        });
    };
    /**
     * Invoice redirection in manage email page for send to client
     */
    DebtorsManagementComponent.prototype.invoiceSendToClientPreview = function (invoice_id) {
        var _this = this;
        if (invoice_id > 0) {
            this._commonCrudService.getData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_9__["AdminAPI"].INVOICE_SHOW, invoice_id).subscribe(function (Response) {
                var invoiceData = Response.payload.data;
                if (invoiceData) {
                    _this._sharedService.setInvoiceData(invoiceData);
                    window.open(_utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_5__["AdminRoutes"].INVOICE_TEMPLATE_PREVIEW, '_blank');
                }
            });
        }
    };
     ...
     * @param clientData
     */
    DebtorsManagementComponent.prototype.onUpdateClient = function (entity_id) {
        var _this = this;
        if (entity_id > 0) {
            this._commonCrudService.getData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_9__["AdminAPI"].CLIENT_BASIC, entity_id, { 'tab': 1 }).subscribe(function (Response) {
                var clientData = Response.payload.data;
                if (clientData) {
                    _this._sharedService.setClientData(_utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_8__["GLOBALDATAKEYS"].CLIENT, clientData);
                    window.open(_utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_5__["AdminRoutes"].UPDATE_CLIENT, '_blank');
                }
            });
        }
    };
     ...
     * On home page route
     */
    DebtorsManagementComponent.prototype.onGoDashboard = function () {
    ...
    ], DebtorsManagementComponent.prototype, "onKeydownHandler", null);
    DebtorsManagementComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-debtors-management',
            template: __webpack_require__(/*! ./debtors-management.component.html */ "./src/app/admin/billing-module/debtors-management/debtors-management.component.html"),
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_15__["DecimalPipe"], _utility_pipe_noComma_pipe__WEBPACK_IMPORTED_MODULE_16__["NoCommaPipe"]],
            styles: [__webpack_require__(/*! ./debtors-management.component.scss */ "./src/app/admin/billing-module/debtors-management/debtors-management.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"], _utility_shared_service_common_crud_service__WEBPACK_IMPORTED_MODULE_10__["CommonCrudService"],
            _utility_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_11__["SharedService"],
            _angular_common__WEBPACK_IMPORTED_MODULE_15__["DecimalPipe"], _utility_pipe_noComma_pipe__WEBPACK_IMPORTED_MODULE_16__["NoCommaPipe"],
            _utility_shared_service_shared_object_service__WEBPACK_IMPORTED_MODULE_12__["SharedObjService"]])
    ], DebtorsManagementComponent);
    return DebtorsManagementComponent;
}());
...
/***/ "./src/app/admin/billing-module/debtors-management/debtors-management.module.ts":
/*!**************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/debtors-management.module.ts ***!
  \**************************************************************************************/
/*! exports provided: DebtorsManagementModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DebtorsManagementModule", function() { return DebtorsManagementModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "../../node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _debtors_management_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./debtors-management.component */ "./src/app/admin/billing-module/debtors-management/debtors-management.component.ts");
...
/* harmony import */ var _add_comments_dialog_add_comments_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./add-comments-dialog/add-comments-dialog.component */ "./src/app/admin/billing-module/debtors-management/add-comments-dialog/add-comments-dialog.component.ts");
/* harmony import */ var _debtors_management_email_template_debtors_management_email_template_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./debtors-management-email-template/debtors-management-email-template.component */ "./src/app/admin/billing-module/debtors-management/debtors-management-email-template/debtors-management-email-template.component.ts");
/* harmony import */ var _separate_invoice_dialog_separate_invoice_dialog_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./separate-invoice-dialog/separate-invoice-dialog.component */ "./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.ts");
...
var routes = [
    {
        path: '',
        component: _debtors_management_component__WEBPACK_IMPORTED_MODULE_2__["DebtorsManagementComponent"],
        canActivate: [_guards_auth_guards__WEBPACK_IMPORTED_MODULE_3__["AdminAuthGuard"]]
    },
    {
        path: 'debtors-management-email-template',
        component: _debtors_management_email_template_debtors_management_email_template_component__WEBPACK_IMPORTED_MODULE_7__["DebtorsManagementEmailTemplateComponent"],
        canActivate: [_guards_auth_guards__WEBPACK_IMPORTED_MODULE_3__["AdminAuthGuard"]]
    },
];
var DebtorsManagementModule = /** @class */ (function () {
    function DebtorsManagementModule() {
    }
    DebtorsManagementModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_debtors_management_component__WEBPACK_IMPORTED_MODULE_2__["DebtorsManagementComponent"], _add_comments_dialog_add_comments_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AddCommentsDialogComponent"], _debtors_management_email_template_debtors_management_email_template_component__WEBPACK_IMPORTED_MODULE_7__["DebtorsManagementEmailTemplateComponent"], _separate_invoice_dialog_separate_invoice_dialog_component__WEBPACK_IMPORTED_MODULE_8__["SeparateInvoiceDialogComponent"]],
            entryComponents: [_add_comments_dialog_add_comments_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AddCommentsDialogComponent"], _separate_invoice_dialog_separate_invoice_dialog_component__WEBPACK_IMPORTED_MODULE_8__["SeparateInvoiceDialogComponent"]]
        })
    ], DebtorsManagementModule);
    return DebtorsManagementModule;
}());
...
/***/ "./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.html":
/*!************************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.html ***!
  \************************************************************************************************************************/
/*! no static exports found */
...
module.exports = "<!--  Invoice log Dialog  -->\r\n<div class=\"modal large-modal\">\r\n  <div class=\"modal__header\">\r\n    <div class=\"modal__header__logo\">Related entity with separate invoice | {{entityName}}</div>\r\n  </div>\r\n\r\n  <div class=\"modal__close\">\r\n    <a><i class=\"material-icons\" (click)=\"onClose()\">close</i></a>\r\n  </div>\r\n\r\n  <div class=\"modal__body\">\r\n    <!-- Start Request Table -->\r\n    <div class=\"table-container dialog-table-container\">\r\n      <div class=\"table-block\">\r\n        <table class=\"PT-0\">\r\n          <thead>\r\n          <tr>\r\n            <th width=\"10%\">Sr. No</th>\r\n            <th width=\"75%\">Related Entity</th>\r\n            <th width=\"15%\">Action</th>\r\n          </tr>\r\n          </thead>\r\n          <tbody *ngIf=\"seperateInvoicedialog.length\">\r\n          <tr *ngFor=\"let seperateinvoice of seperateInvoicedialog; let i = index\">\r\n            <td>{{i+1}}</td>\r\n            <td>{{seperateinvoice?.billing_name}}</td>\r\n            <td><a class=\"orange-color\" [matTooltip]=\"'Edit this Client'\" (click)=\"onEditThisClient(seperateinvoice)\">\r\n              <mat-icon>edit</mat-icon>\r\n            </a></td>\r\n          </tr>\r\n          </tbody>\r\n        </table>\r\n        <table *ngIf=\"seperateInvoicedialog.length\">\r\n          <tfoot>\r\n          <tr>\r\n            <td colspan=\"10\">\r\n              <mat-paginator [length]=\"totalRecords\"\r\n                             [pageSize]=\"pageSize\"\r\n                             [pageIndex]=\"pageIndex\"\r\n                             [pageSizeOptions]=\"pageArray\"\r\n                             (page)=\"onPageChange($event)\">\r\n              </mat-paginator>\r\n            </td>\r\n          </tr>\r\n          </tfoot>\r\n        </table>\r\n      </div>\r\n    </div>\r\n    <div *ngIf=\"seperateInvoicedialog.length === 0\" class=\"panel-title red-color\">\r\n      No Records Found!\r\n    </div>\r\n    <!-- End Request Table -->\r\n  </div>\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.scss":
/*!************************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.scss ***!
  \************************************************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJwcm9qZWN0cy9hZG1pbi9zcmMvYXBwL2FkbWluL2JpbGxpbmctbW9kdWxlL2RlYnRvcnMtbWFuYWdlbWVudC9zZXBhcmF0ZS1pbnZvaWNlLWRpYWxvZy9zZXBhcmF0ZS1pbnZvaWNlLWRpYWxvZy5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.ts":
/*!**********************************************************************************************************************!*\
  !*** ./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.ts ***!
  \**********************************************************************************************************************/
/*! exports provided: SeparateInvoiceDialogComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SeparateInvoiceDialogComponent", function() { return SeparateInvoiceDialogComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/material */ "../../node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "../../node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../utility/constants/admin-route */ "./src/utility/constants/admin-route.ts");
...
var SeparateInvoiceDialogComponent = /** @class */ (function () {
    function SeparateInvoiceDialogComponent(dialogRef, _sharedObjService, data, _fb, _router, _commonCrudService, _sharedService) {
    ...
    SeparateInvoiceDialogComponent.prototype.ngOnInit = function () {
        this.initializationMethod();
    };
    SeparateInvoiceDialogComponent.prototype.onClose = function () {
        this.dialogRef.close();
    };
    /**
     * Initialization Methods
     */
    SeparateInvoiceDialogComponent.prototype.initializationMethod = function () {
     ...
     * @param {string} val
     */
    SeparateInvoiceDialogComponent.prototype.getSeperateInvoiceList = function (pageNumber, key, val) {
        var _this = this;
        this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_6__["AdminAPI"].CLIENT_LIST, {}, { 'in': { 'id': this.entity_id } }).subscribe(function (Response) {
            _this.handleSeperateInvoiceResponse(Response);
        });
     ...
     * @param response
     */
    SeparateInvoiceDialogComponent.prototype.handleSeperateInvoiceResponse = function (response) {
        this.seperateInvoicedialog = response.payload.data;
        this.page = response.pager.pageNumber;
        this.pageIndex = this.page - 1;
        this.totalRecords = +response.pager.totalRecords;
     ...
     * @param event
     */
    SeparateInvoiceDialogComponent.prototype.onPageChange = function (event) {
        this.pageSize = event.pageSize;
     ...
     * @param clientData
     */
    SeparateInvoiceDialogComponent.prototype.onEditThisClient = function (clientData) {
        if (clientData) {
            this._sharedService.setClientData(_utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_7__["GLOBALDATAKEYS"].CLIENT, clientData);
            window.open(_utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_3__["AdminRoutes"].UPDATE_CLIENT, '_blank');
        }
    };
    SeparateInvoiceDialogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-separate-invoice-dialog',
            template: __webpack_require__(/*! ./separate-invoice-dialog.component.html */ "./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.html"),
            styles: [__webpack_require__(/*! ./separate-invoice-dialog.component.scss */ "./src/app/admin/billing-module/debtors-management/separate-invoice-dialog/separate-invoice-dialog.component.scss")]
        }),
        __param(2, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"],
            _utility_shared_service_shared_object_service__WEBPACK_IMPORTED_MODULE_9__["SharedObjService"], Object, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _utility_shared_service_common_crud_service__WEBPACK_IMPORTED_MODULE_5__["CommonCrudService"], _utility_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_8__["SharedService"]])
    ], SeparateInvoiceDialogComponent);
    return SeparateInvoiceDialogComponent;
}());
...
//# sourceMappingURL=debtors-management-debtors-management-module.js.map