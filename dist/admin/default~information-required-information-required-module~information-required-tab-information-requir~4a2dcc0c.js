(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~information-required-information-required-module~information-required-tab-information-requir~4a2dcc0c"],{

/***/ "./src/app/admin/client-module/information-required/information-required-tab/upload-info-documents-dialog/upload-info-documents-dialog.component.html":
/*!************************************************************************************************************************************************************!*\
  !*** ./src/app/admin/client-module/information-required/information-required-tab/upload-info-documents-dialog/upload-info-documents-dialog.component.html ***!
  \************************************************************************************************************************************************************/
...
var UploadInfoDocumentsDialogComponent = /** @class */ (function () {
    function UploadInfoDocumentsDialogComponent(dialogRef, data, _router, _fb, sanitizer, _commonCrudService, _sharedService, dialog) {
        ...
        this.informationDetailId = 0;
    }
    UploadInfoDocumentsDialogComponent.prototype.ngOnInit = function () {
     ...
     * Get File Type List
     */
    UploadInfoDocumentsDialogComponent.prototype.getFileTypeList = function () {
        var _this = this;
    ...
    UploadInfoDocumentsDialogComponent.prototype.createFolderListForMoveFile = function () {
        var _this = this;
        var params = { 'entity_id': this.informationData.entity_id };
        // console.log(1);
    ...
    UploadInfoDocumentsDialogComponent.prototype.getNestedChildren = function (arr, parent) {
        var out = [];
        for (var i in arr) {
     ...
     * @param parent_id
     */
    UploadInfoDocumentsDialogComponent.prototype.googleDriveList = function (entity_id, parent_id, subclient_id) {
        var _this = this;
        this.createAdvanceFilterForm();
        ...
        this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_10__["AdminAPI"].GOOGLE_DRIVE_LIST, params).subscribe(function (response) {
            ...
            if (parent_id === 0 && subclient_id === 0) {
                ...
                _this.googleDriveAllFileFolder.entity_id = _this.informationData.entity_id;
     ...
     * @param parent_id
     */
    UploadInfoDocumentsDialogComponent.prototype.openSubFolder = function (entity_id, parent_id, subclient_id) {
     ...
     * @param parent_id
     */
    UploadInfoDocumentsDialogComponent.prototype.openBreadCrumFolder = function (entity_id, parent_id, index, folder, subclient_id) {
     ...
     * On Refresh Folder
     */
    UploadInfoDocumentsDialogComponent.prototype.onRefreshFolder = function () {
     ...
     * @param type
     */
    UploadInfoDocumentsDialogComponent.prototype.getGoogleDriveMetaDataType = function (keyType, valueType, returnType) {
     ...
     * @param fileSize
     */
    UploadInfoDocumentsDialogComponent.prototype.getFileSizeInFormat = function (fileSize) {
     ...
     * On home page route
     */
    UploadInfoDocumentsDialogComponent.prototype.onGoDashboard = function () {
     ...
     */
    UploadInfoDocumentsDialogComponent.prototype.onClient = function () {
        this._router.navigate(['/' + _utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_11__["AdminRoutes"].VIEW_CLIENT]);
    };
    /**
     * Create search filter
     */
    UploadInfoDocumentsDialogComponent.prototype.createAdvanceFilterForm = function () {
        this.filterForm = this._fb.group({
            entity_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.informationData.entity_id, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
     ...
     */
    UploadInfoDocumentsDialogComponent.prototype.resetFilterForm = function () {
        this.createAdvanceFilterForm();
        this.googleDriveList(this.informationData.entity_id, 0, 0);
    };
    /**
     ...
     * @param form
     */
    UploadInfoDocumentsDialogComponent.prototype.searchFilesFromEntity = function (form) {
        var _this = this;
        // console.log(form);
        if (form.valid) {
            this.isOpenFilterView = false;
    ...
    UploadInfoDocumentsDialogComponent.prototype.toggleDisplay = function (value) {
        this.isShow = value;
    };
    /**
     * Sort By
     */
    UploadInfoDocumentsDialogComponent.prototype.getSortData = function (sortKey, sortVal) {
        this.sortBy = sortKey;
     ...
     */
    UploadInfoDocumentsDialogComponent.prototype.onSelectFolderItem = function (event, googleDriveFolder) {
        if (event.checked) {
     ...
     */
    UploadInfoDocumentsDialogComponent.prototype.onSelectFileItem = function (event, googleDriveFile) {
        if (event.checked) {
     ...
     * @param event
     */
    UploadInfoDocumentsDialogComponent.prototype.onSelectAllFileItem = function (event, googleDriveFile) {
        var _this = this;
        if (event === true) {
            this.selectedFileArray = [];
     ...
     * @param folderData
     */
    UploadInfoDocumentsDialogComponent.prototype.getFolderColor = function (folderData) {
     ...
     * @param folderData
     */
    UploadInfoDocumentsDialogComponent.prototype.getFolderTextColor = function (folderData) {
        if (folderData.emptyFolder === 1) {
            return "red-color";
        }
        else if (folderData.directory_id === 0) {
     ...
     * Open filter
     */
    UploadInfoDocumentsDialogComponent.prototype.onOpenFilter = function () {
        this.isOpenFilterView = true;
    };
    /**
     * close filter
     */
    UploadInfoDocumentsDialogComponent.prototype.onCloseFilter = function () {
        this.isOpenFilterView = false;
    };
    /**
     * Toogle Filter
     */
    UploadInfoDocumentsDialogComponent.prototype.onToggleFilter = function () {
     ...
     * @param value
     */
    UploadInfoDocumentsDialogComponent.prototype.onClose = function (value) {
        var params = {};
        params['result'] = value;
     ...
     */
    UploadInfoDocumentsDialogComponent.prototype.onInsertIntoInformation = function () {
        var _this = this;
    ...
    ], UploadInfoDocumentsDialogComponent.prototype, "contextMenu", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatMenuTrigger"]),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatMenuTrigger"])
    ], UploadInfoDocumentsDialogComponent.prototype, "menuDataItem", void 0);
    UploadInfoDocumentsDialogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-upload-info-documents-dialog',
            template: __webpack_require__(/*! ./upload-info-documents-dialog.component.html */ "./src/app/admin/client-module/information-required/information-required-tab/upload-info-documents-dialog/upload-info-documents-dialog.component.html")
        }),
    ...
    ], UploadInfoDocumentsDialogComponent);
    return UploadInfoDocumentsDialogComponent;
}());
...
//# sourceMappingURL=default~information-required-information-required-module~information-required-tab-information-requir~4a2dcc0c.js.map