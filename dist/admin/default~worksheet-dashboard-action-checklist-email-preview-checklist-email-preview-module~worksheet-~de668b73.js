(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~worksheet-dashboard-action-checklist-email-preview-checklist-email-preview-module~worksheet-~de668b73"],{

/***/ "./src/app/admin/workflow-module/worksheet-module/worksheet-dashboard-action/edit-task-checklist/upload-documents-dialog/upload-documents-dialog.component.html":
/*!**********************************************************************************************************************************************************************!*\
  !*** ./src/app/admin/workflow-module/worksheet-module/worksheet-dashboard-action/edit-task-checklist/upload-documents-dialog/upload-documents-dialog.component.html ***!
  \**********************************************************************************************************************************************************************/
...
var UploadDocumentsDialogComponent = /** @class */ (function () {
    function UploadDocumentsDialogComponent(dialogRef, data, _router, _fb, sanitizer, _commonCrudService, _sharedService, dialog) {
        ...
        this.dialog = dialog;
        // Google Picker
        this.developerKey = _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["GoogleDriveSettings"].API_KEY;
        this.clientId = _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["GoogleDriveSettings"].CLIENT_SECRET;
        this.scope = [
            _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["GoogleDriveSettings"].SCOPE_PROFILE,
            _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["GoogleDriveSettings"].SCOPE_EMAIL,
            _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["GoogleDriveSettings"].SCOPE_URL
        ].join(' ');
        ...
        this.googleDriveTrashFolder = new _client_module_client_documents_google_drive_model__WEBPACK_IMPORTED_MODULE_2__["GoogleDriveFolder"]();
        this.googleDriveAllFileFolder = new _client_module_client_documents_google_drive_model__WEBPACK_IMPORTED_MODULE_2__["GoogleDriveFolder"]();
        ...
        this.validationMsg = new _utility_validation__WEBPACK_IMPORTED_MODULE_3__["ValidationConstantMessage"]();
        ...
        this.maxFileAllowed = _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["BASE"].MAXIMUM_FILE_ALLOWED_TO_SELECT;
        this.finalArrayFolderList = [];
        this.documentUploadType = 0;
    }
    UploadDocumentsDialogComponent.prototype.ngOnInit = function () {
        this.getFileTypeList();
        this.clientData = (this.data) ? this.data.clientData : null;
        this.documentUploadType = (this.data) ? this.data.uploadType : null;
        this.breadCrumsList.push({ 'entity_id': this.clientData.entity_id, 'directory_name': 'Home', 'parent_id': 0, 'id': 0, 'folder': null, 'subclient_id': 0 });
        this.googleDriveList(this.clientData.entity_id, 0, 0);
     ...
     * Get File Type List
     */
    UploadDocumentsDialogComponent.prototype.getFileTypeList = function () {
        var _this = this;
    ...
    UploadDocumentsDialogComponent.prototype.createFolderListForMoveFile = function () {
        var _this = this;
        var params = { 'entity_id': this.clientData.entity_id };
        // console.log(1);
    ...
    UploadDocumentsDialogComponent.prototype.getNestedChildren = function (arr, parent) {
        var out = [];
        for (var i in arr) {
     ...
     * @param parent_id
     */
    UploadDocumentsDialogComponent.prototype.googleDriveList = function (entity_id, parent_id, subclient_id) {
        var _this = this;
        this.createAdvanceFilterForm();
        ...
        this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_10__["AdminAPI"].GOOGLE_DRIVE_LIST, params).subscribe(function (response) {
            ...
            if (parent_id === 0 && subclient_id === 0) {
                ...
                _this.googleDriveAllFileFolder.entity_id = _this.clientData.entity_id;
                _this.googleDriveAllFileFolder.parent_id = -2;
                _this.googleDriveAllFileFolder.directory_name = _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["BASE"].ALL_FILE_FOLDER_NAME;
            ...
            _this.maxFileAllowed = (_utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["BASE"].MAXIMUM_FILE_ALLOWED_TO_SELECT <= _this.googleDriveFileList.length) ? _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["BASE"].MAXIMUM_FILE_ALLOWED_TO_SELECT : _this.googleDriveFileList.length;
        });
    };
    /**
     * Open Sub Folder
     ...
     * @param parent_id
     */
    UploadDocumentsDialogComponent.prototype.openSubFolder = function (entity_id, parent_id, subclient_id) {
     ...
     * @param parent_id
     */
    UploadDocumentsDialogComponent.prototype.openBreadCrumFolder = function (entity_id, parent_id, index, folder, subclient_id) {
     ...
     * On Refresh Folder
     */
    UploadDocumentsDialogComponent.prototype.onRefreshFolder = function () {
     ...
     * @param type
     */
    UploadDocumentsDialogComponent.prototype.getGoogleDriveMetaDataType = function (keyType, valueType, returnType) {
     ...
     * @param fileSize
     */
    UploadDocumentsDialogComponent.prototype.getFileSizeInFormat = function (fileSize) {
        var val = Object(_utility_common_functions__WEBPACK_IMPORTED_MODULE_13__["bytesToSize"])(Number(fileSize));
        return val;
    };
    /**
     * On home page route
     */
    UploadDocumentsDialogComponent.prototype.onGoDashboard = function () {
     ...
     */
    UploadDocumentsDialogComponent.prototype.onClient = function () {
        this._router.navigate(['/' + _utility_constants_admin_route__WEBPACK_IMPORTED_MODULE_11__["AdminRoutes"].VIEW_CLIENT]);
    };
    /**
     * Create search filter
     */
    UploadDocumentsDialogComponent.prototype.createAdvanceFilterForm = function () {
        this.filterForm = this._fb.group({
            entity_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](this.clientData.entity_id, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required),
            type: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null),
            modified_on_from: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null),
            modified_on_to: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null),
            file_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null),
            path: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](null)
        });
    };
    /**
     * On Reset Filter Form
     */
    UploadDocumentsDialogComponent.prototype.resetFilterForm = function () {
        this.createAdvanceFilterForm();
        this.googleDriveList(this.clientData.entity_id, 0, 0);
    };
    /**
     ...
     * @param form
     */
    UploadDocumentsDialogComponent.prototype.searchFilesFromEntity = function (form) {
        var _this = this;
        // console.log(form);
        if (form.valid) {
            this.isOpenFilterView = false;
            form.value['modified_on_from'] = (form.value['modified_on_from']) ? moment__WEBPACK_IMPORTED_MODULE_14__(form.value['modified_on_from']).format('YYYY-MM-DD') : null;
            form.value['modified_on_to'] = (form.value['modified_on_to']) ? moment__WEBPACK_IMPORTED_MODULE_14__(form.value['modified_on_to']).format('YYYY-MM-DD') : null;
    ...
    UploadDocumentsDialogComponent.prototype.toggleDisplay = function (value) {
        this.isShow = value;
    };
    /**
     * Sort By
     */
    UploadDocumentsDialogComponent.prototype.getSortData = function (sortKey, sortVal) {
        this.sortBy = sortKey;
     ...
     */
    UploadDocumentsDialogComponent.prototype.onSelectFolderItem = function (event, googleDriveFolder) {
        if (event.checked) {
     ...
     */
    UploadDocumentsDialogComponent.prototype.onSelectFileItem = function (event, googleDriveFile) {
        if (event.checked) {
            if (this.selectedFileArray.length < this.maxFileAllowed) {
                this.selectedFileArray.push(googleDriveFile.file_id);
            }
            else {
                this._sharedService.setToastMessage("You can select maximum " + this.maxFileAllowed + " file.", _utility_constants_base_constants__WEBPACK_IMPORTED_MODULE_5__["ToastType"].WARNING);
            }
        }
        else {
     ...
     * @param event
     */
    UploadDocumentsDialogComponent.prototype.onSelectAllFileItem = function (event, googleDriveFile) {
        var _this = this;
        if (event === true) {
            this.selectedFileArray = [];
     ...
     * @param folderData
     */
    UploadDocumentsDialogComponent.prototype.getFolderColor = function (folderData) {
     ...
     * @param folderData
     */
    UploadDocumentsDialogComponent.prototype.getFolderTextColor = function (folderData) {
        if (folderData.emptyFolder === 1) {
            return "red-color";
        }
        else if (folderData.directory_id === 0) {
     ...
     * Open filter
     */
    UploadDocumentsDialogComponent.prototype.onOpenFilter = function () {
        this.isOpenFilterView = true;
    };
    /**
     * close filter
     */
    UploadDocumentsDialogComponent.prototype.onCloseFilter = function () {
        this.isOpenFilterView = false;
    };
    /**
     * Toogle Filter
     */
    UploadDocumentsDialogComponent.prototype.onToggleFilter = function () {
        this.isOpenFilterView = !this.isOpenFilterView;
    };
    /**
     * Complete or Not Complete open confirmation modal
     */
    UploadDocumentsDialogComponent.prototype.onMarkAsCompleteFile = function (file, action) {
        var _this = this;
        var actionType = action === 1 ? 'Completed' : 'Not Completed';
        ...
        dialogRef.afterClosed().subscribe(function (value) {
            if (value) {
                ...
                _this._commonCrudService.addData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_10__["AdminAPI"].GOOGLE_DRIVE_MARK_AS_COMPLETED, itemData).subscribe(function (response) {
                    _this.googleDriveFileList.map(function (item) {
                        if (item.id === file.id) {
     ...
     * @param value
     */
    UploadDocumentsDialogComponent.prototype.onClose = function (value) {
        this.dialogRef.close(value);
    };
    /**
     * On Insert into worksheet
     */
    UploadDocumentsDialogComponent.prototype.onInsertIntoWorksheet = function () {
        var _this = this;
        if (this.selectedFileArray.length) {
            var params = {};
            params['worksheet_id'] = this.clientData.id;
            params['entity_id'] = this.clientData.entity_id;
            params['document_type'] = this.documentUploadType;
            params['document_file'] = this.selectedFileArray.join(',');
            params['is_sent'] = (this.documentUploadType === 1) ? 1 : 0;
            params['document_insert_type'] = 1;
            if (params) {
    ...
    ], UploadDocumentsDialogComponent.prototype, "contextMenu", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatMenuTrigger"]),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatMenuTrigger"])
    ], UploadDocumentsDialogComponent.prototype, "menuDataItem", void 0);
    UploadDocumentsDialogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-upload-documents-dialog',
            template: __webpack_require__(/*! ./upload-documents-dialog.component.html */ "./src/app/admin/workflow-module/worksheet-module/worksheet-dashboard-action/edit-task-checklist/upload-documents-dialog/upload-documents-dialog.component.html")
        }),
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"], Object, _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_7__["DomSanitizer"],
            _utility_shared_service_common_crud_service__WEBPACK_IMPORTED_MODULE_8__["CommonCrudService"], _utility_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_6__["SharedService"], _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]])
    ], UploadDocumentsDialogComponent);
    return UploadDocumentsDialogComponent;
}());
...
//# sourceMappingURL=default~worksheet-dashboard-action-checklist-email-preview-checklist-email-preview-module~worksheet-~de668b73.js.map