(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~worksheet-dashboard-action-edit-task-checklist-knockback-edit-task-checklist-knockback-modul~bca454f2"],{

/***/ "./src/app/admin/workflow-module/worksheet-module/worksheet-dashboard-action/edit-task-checklist-knockback/add-timesheet-dialog-knockback/add-timesheet-dialog-knockback.component.html":
/*!**********************************************************************************************************************************************************************************************!*\
  !*** ./src/app/admin/workflow-module/worksheet-module/worksheet-dashboard-action/edit-task-checklist-knockback/add-timesheet-dialog-knockback/add-timesheet-dialog-knockback.component.html ***!
  \**********************************************************************************************************************************************************************************************/
...
/* harmony import */ var _utility_constants_timesheet_constant__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../../../utility/constants/timesheet-constant */ "./src/utility/constants/timesheet-constant.ts");
...
var AddTimesheetDialogKnockbackComponent = /** @class */ (function (_super) {
    __extends(AddTimesheetDialogKnockbackComponent, _super);
    function AddTimesheetDialogKnockbackComponent(dialogRef, data, _router, _fb, _sharedService, _commonCrudService, _sharedObjService) {
        ...
        _this.timesheetConstant = _utility_constants_timesheet_constant__WEBPACK_IMPORTED_MODULE_5__["TimesheetConstantData"];
        _this.periodList = [];
        _this.payrollOptionList = [];
        _this.frequencyDDList = [];
        _this.flagToSubmit = 0;
        _this.reviewWriteOffData = [];
        _this.isReviewerWriteOff = 0;
        _this.subClientList = [];
        return _this;
    }
    AddTimesheetDialogKnockbackComponent.prototype.ngOnInit = function () {
     ...
     * Get Dropdown data
     */
    AddTimesheetDialogKnockbackComponent.prototype.getDropdownData = function () {
        var _this = this;
        // Get Frequency
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.createTimesheetForm = function () {
        // console.log(this.worksheetData);
        this.addTimesheetForm = this._fb.group({
            worksheet_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((this.worksheetData) ? this.worksheetData.id : 0),
            entity_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((this.worksheetData) ? this.worksheetData.entity_id : 0, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
            parent_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((this.worksheetData && this.worksheetData.parent_id > 0) ? this.worksheetData.parent_id : null),
            date: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](new Date()),
            frequency: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((this.worksheetData) ? this.worksheetData.frequency_id : 0),
            period_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((this.worksheetData) ? this.worksheetData.id : 0),
            master_activity_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((this.worksheetData) ? this.worksheetData.master_activity_id.id : 0),
            task_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]((this.worksheetData) ? this.worksheetData.task_id.id : 0),
            ...
            start_time: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](''),
            end_time: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](''),
            units: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(_utility_validation__WEBPACK_IMPORTED_MODULE_2__["CommonRegex"].NUMERIC_REGEXP), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(_utility_validation__WEBPACK_IMPORTED_MODULE_2__["CommonRegex"].NOT_ALLOWED_FIRST_ZERO_NUMBER_REGEXP)]),
            ...
            reviewer_comment: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](null),
            reviewer_reason: this._fb.array([]),
            timesheet_unit: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](null),
            budgeted_unit: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](null)
        });
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.getSubClientList = function () {
        var _this = this;
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.getReviewerReason = function () {
        return this.addTimesheetForm.get('reviewer_reason');
    };
    /**
     * Get Extra Field Array
     */
    AddTimesheetDialogKnockbackComponent.prototype.getExtraFieldArray = function () {
        return this.addTimesheetForm.get('extra_fields');
    };
    /**
     * Get Name Of Employee
     */
    AddTimesheetDialogKnockbackComponent.prototype.getNameOfEmployeeArray = function () {
     ...
     * @param value
     */
    AddTimesheetDialogKnockbackComponent.prototype.getTaskFilterList = function (value) {
        var _this = this;
        // Get Task
        // console.log(2);
        if (value) {
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.getMasterActivityList = function () {
        var _this = this;
     ...
     * Get Task List
     */
    AddTimesheetDialogKnockbackComponent.prototype.getTaskList = function () {
        var _this = this;
        var entity_id = this.addTimesheetForm.get('entity_id').value;
     ...
     * Get Frequency List
     */
    AddTimesheetDialogKnockbackComponent.prototype.getFrequencyList = function () {
        var _this = this;
     ...
     * Get Period List
     */
    AddTimesheetDialogKnockbackComponent.prototype.getPeriodList = function () {
        var _this = this;
        var task_id = this.addTimesheetForm.get('task_id').value;
        var entity_id = this.addTimesheetForm.get('entity_id').value;
        var master_activity_id = this.addTimesheetForm.get('master_activity_id').value;
        var frequency = this.addTimesheetForm.get('frequency').value;
     ...
     * @param value
     */
    AddTimesheetDialogKnockbackComponent.prototype.getSubactivityFilterList = function (value) {
        var _this = this;
     ...
     * @param subActivity
     */
    AddTimesheetDialogKnockbackComponent.prototype.hideShowFields = function (value) {
        var _this = this;
        if (value) {
            // console.log(value);
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.updateUnits = function () {
     ...
     * @param index
     */
    AddTimesheetDialogKnockbackComponent.prototype.getSubactivityField = function (index) {
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.createDynamicFields = function (item) {
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.createDynamicEmployeeNameFields = function (item) {
        return this._fb.group({
     ...
     * @param value
     */
    AddTimesheetDialogKnockbackComponent.prototype.onUpdateValues = function (index, value, checked, keyData) {
        if (index >= 0) {
            if (value) {
     ...
     * @param value
     */
    AddTimesheetDialogKnockbackComponent.prototype.addEmployeeFields = function (value) {
     ...
     * @param value
     */
    AddTimesheetDialogKnockbackComponent.prototype.onUpdateEmployeeValues = function (index, value, key) {
        if (index >= 0) {
            if (value) {
     ...
     * @param value
     */
    AddTimesheetDialogKnockbackComponent.prototype.onUpdateDateValues = function (index, value) {
        if (index >= 0) {
            if (value) {
     ...
     * @constructor
     */
    AddTimesheetDialogKnockbackComponent.prototype.UpdateFormControl = function () {
     ...
     * @constructor
     */
    AddTimesheetDialogKnockbackComponent.prototype.UpdateFormControlEmployee = function () {
     ...
     * @param value
     */
    AddTimesheetDialogKnockbackComponent.prototype.checkReviewerBudgetedUnit = function (value) {
        var _this = this;
        if (Number((value) > 0)) {
            this._commonCrudService.listData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_10__["AdminAPI"].WORKSHEET_REVIEWER_UNIT, {
                'entity_id': this.worksheetData.entity_id,
                'worksheet_id': this.worksheetData.id
            }, {}).subscribe(function (response) {
                var budgetedUnit = Number(response.payload.data.budgeted_unit);
                var filledUnit = response.payload.data.filled_unit;
                _this.reviewWriteOffData = response.payload.data.reviwerReason;
                var iswriteoffEntryExist = Number(response.payload.data.writeoff);
                var totalUnits = Number(filledUnit) + Number(value);
                // console.log(totalUnits, budgetedUnit, iswriteoffEntryExist, this.worksheetData.status_id.id);
                if ((totalUnits > budgetedUnit) && (iswriteoffEntryExist === 0) && (_this.worksheetData.status_id.id === 2) && ((_this.worksheetData.service_id === 1))) {
                    _this.isReviewerWriteOff = 1;
                    if (_this.reviewWriteOffData.length) {
                        _this.addTimesheetForm.get('timesheet_unit').setValue(totalUnits);
                        _this.addTimesheetForm.get('budgeted_unit').setValue(budgetedUnit);
                        // this.addTimesheetForm
                        _this.addTimesheetForm.get('reviewer_reason').reset([]);
                        _this.addTimesheetForm.removeControl('reviewer_reason');
                        _this.addTimesheetForm.addControl('reviewer_reason', _this._fb.array([], _this.minSelectedCheckboxes(1)));
                        _this.reviewWriteOffData.forEach(function (item) {
                            _this.getReviewerReason().push(_this.createReasonGroup(item));
                        });
                        var otherReason = [];
                        otherReason['id'] = 0;
                        otherReason['reason'] = 'Other';
                        otherReason['selected'] = 0;
                        _this.getReviewerReason().push(_this.createReasonGroup(otherReason));
                    }
                }
                else {
                    _this.isReviewerWriteOff = 0;
                    _this.addTimesheetForm.get('reviewer_reason').reset([]);
                    _this.addTimesheetForm.get('timesheet_unit').setValue(null);
                    _this.addTimesheetForm.get('budgeted_unit').setValue(null);
                    _this.addTimesheetForm.removeControl('reviewer_reason');
                    _this.addTimesheetForm.addControl('reviewer_reason', _this._fb.array([]));
                }
            });
        }
    };
     ...
     * @param id
     */
    AddTimesheetDialogKnockbackComponent.prototype.changeUpdateReviewerWriteOff = function (event, filterGroup, index, id) {
        if (event) {
            this.getReviewerReason().controls[index].get('selected').setValue(1);
            if (id === 0) {
                this.addTimesheetForm.get('reviewer_comment').setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required);
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.createReasonGroup = function (item) {
        return this._fb.group({
            id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](item ? item['id'] : ''),
            reason: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](item ? item['reason'] : ''),
            selected: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](item ? item['selected'] : '')
        });
    };
    /**
     ...
     * @param min
     */
    AddTimesheetDialogKnockbackComponent.prototype.minSelectedCheckboxes = function (min) {
        if (min === void 0) { min = 1; }
        var validator = function (formArray) {
            var totalSelected = formArray.controls
                // get a list of checkbox values (boolean)
                .filter(function (control) { return control.value['selected'] === 1; });
     ...
     * @param type
     */
    AddTimesheetDialogKnockbackComponent.prototype.flagToSubmitUpdate = function (type) {
     ...
     * @param form
     */
    AddTimesheetDialogKnockbackComponent.prototype.onSubmitTimesheet = function (form) {
        var _this = this;
        if (form.valid) {
            ...
            if (form.value) {
                ...
                if (this.isReviewerWriteOff === 1) {
                    var ReviewerReason = form.value['reviewer_reason'];
                    var staff_json_1 = {};
                    staff_json_1['rawData'] = [];
                    staff_json_1['coreData'] = [];
                    staff_json_1['allData'] = [];
                    var staffJSON = form.value['reviewer_reason'];
                    staffJSON.forEach(function (item) {
                        if (item['selected'] === 1) {
                            staff_json_1['coreData'].push(item['id']);
                            staff_json_1['rawData'].push(item['reason']);
                        }
                        staff_json_1['allData'].push(item);
                    });
                    form.value['reviewer_reason'] = JSON.stringify(staff_json_1);
                    this._commonCrudService.addData(_utility_constants_api__WEBPACK_IMPORTED_MODULE_10__["AdminAPI"].REVIEWER_WRITEOFF_ADD, form.value).subscribe(function (response) {
                        _this.getHRDetail();
                        if (_this.flagToSubmit === 0) {
                            _this.addEditTimesheetDataForm.resetForm();
                            _this.createTimesheetForm();
     ...
     * On page worksheet
     */
    AddTimesheetDialogKnockbackComponent.prototype.onWorksheet = function () {
     ...
     */
    AddTimesheetDialogKnockbackComponent.prototype.onTodaysTimesheet = function () {
    ...
    AddTimesheetDialogKnockbackComponent.prototype.onClose = function () {
        this.dialogRef.close(false);
    };
    /**
     * Update units on header
     */
    AddTimesheetDialogKnockbackComponent.prototype.getHRDetail = function () {
        var _this = this;
     ...
     * @param event
     */
    AddTimesheetDialogKnockbackComponent.prototype.onChangeParentEntity = function (event) {
    ...
    ], AddTimesheetDialogKnockbackComponent.prototype, "addEditTimesheetDataForm", void 0);
    AddTimesheetDialogKnockbackComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-add-timesheet-dialog-knockback',
            template: __webpack_require__(/*! ./add-timesheet-dialog-knockback.component.html */ "./src/app/admin/workflow-module/worksheet-module/worksheet-dashboard-action/edit-task-checklist-knockback/add-timesheet-dialog-knockback/add-timesheet-dialog-knockback.component.html")
        }),
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"], Object, _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _utility_shared_service_shared_service__WEBPACK_IMPORTED_MODULE_7__["SharedService"], _utility_shared_service_common_crud_service__WEBPACK_IMPORTED_MODULE_8__["CommonCrudService"], _utility_shared_service_shared_object_service__WEBPACK_IMPORTED_MODULE_9__["SharedObjService"]])
    ], AddTimesheetDialogKnockbackComponent);
    return AddTimesheetDialogKnockbackComponent;
...
//# sourceMappingURL=default~worksheet-dashboard-action-edit-task-checklist-knockback-edit-task-checklist-knockback-modul~bca454f2.js.map